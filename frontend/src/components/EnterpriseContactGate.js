    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center px-4">
        <div className="max-w-lg w-full text-center">
          ...
          <h2 className="text-3xl font-normal mb-3" style={{ color: '#F4F7FA', fontFamily: HEAD }}>Request received.</h2>
          <p className="text-sm leading-relaxed mb-2" style={{ color: '#9FB0C3', fontFamily: BODY }}>
            Your callback has been scheduled for <strong style={{ color: '#F4F7FA' }}>{form.selectedDate} at {form.selectedTime}</strong>.
          </p>
          <p className="text-sm" style={{ color: '#9FB0C3', fontFamily: BODY }}>
          ...
          <div className="mt-6 p-4 rounded-xl" style={{ background: '#141C26', border: '1px solid #243140' }}>
            <p className="text-[11px] tracking-widest uppercase mb-1" style={{ color: '#FF6A00', fontFamily: MONO }}>What happens next</p>
            <p className="text-xs" style={{ color: '#64748B', fontFamily: BODY }}>Our strategic intelligence team will review your requirements and prepare a tailored demonstration of {featureName}.</p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8">
      ...
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          <h1 className="text-2xl font-normal" style={{ color: '#F4F7FA', fontFamily: HEAD }}>{featureName}</h1>
          <p className="text-sm" style={{ color: '#64748B', fontFamily: BODY }}>Available on Growth and Enterprise plans. Request access below.</p>
        </div>
        <div className="ml-auto text-right shrink-0">
          <span className="text-[10px] px-2 py-1 rounded-full" style={{ background: '#FF6A0015', color: '#FF6A00', fontFamily: MONO }}>ENTERPRISE</span>
        </div>
      </div>

      {/* Form */}
      <div className="rounded-2xl p-6 space-y-5" style={{ background: '#141C26', border: '1px solid #243140' }}>
        <h2 className="text-lg font-semibold mb-4" style={{ color: '#F4F7FA', fontFamily: HEAD }}>Request a Callback</h2>

        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            <label className="text-[11px] uppercase tracking-wider block mb-1.5" style={{ color: '#64748B', fontFamily: MONO }}>Full Name *</label>
          ...
          <div>
            <label className="text-[11px] uppercase tracking-wider block mb-1.5" style={{ color: '#64748B', fontFamily: MONO }}>Business Name</label>
          ...
          <div>
            <label className="text-[11px] uppercase tracking-wider block mb-1.5" style={{ color: '#64748B', fontFamily: MONO }}>Email Address *</label>
          ...
          <div>
            <label className="text-[11px] uppercase tracking-wider block mb-1.5" style={{ color: '#64748B', fontFamily: MONO }}>Mobile / Phone</label>
        ...
        {/* Callback Calendar */}
        <div>
          <label className="text-[11px] uppercase tracking-wider block mb-1.5" style={{ color: '#64748B', fontFamily: MONO }}>
          ...
          <button onClick={() => setShowCal(!showCal)}
            ...
            style={{ background: '#0F1720', border: `1px solid ${form.selectedDate ? '#FF6A0040' : '#243140'}`, color: form.selectedDate ? '#F4F7FA' : '#64748B', fontFamily: BODY }}>
          ...
          {showCal && (
            <div className="mt-2 rounded-xl p-4" style={{ background: '#0F1720', border: '1px solid #243140' }}>
              {/* Date picker */}
              <p className="text-[10px] uppercase tracking-wider mb-3" style={{ color: '#64748B', fontFamily: MONO }}>Select Date</p>
              ...
              {/* Time picker */}
              <p className="text-[10px] uppercase tracking-wider mb-3" style={{ color: '#64748B', fontFamily: MONO }}>Select Time (AEST)</p>
        ...
        {/* Problem Description */}
        <div>
          <label className="text-[11px] uppercase tracking-wider block mb-1.5" style={{ color: '#64748B', fontFamily: MONO }}>What intelligence are you looking for? *</label>
          <p className="text-[11px] mb-2" style={{ color: '#64748B', fontFamily: BODY }}>Briefly describe what you want to achieve and the problem you're trying to solve.</p>
          ...
          <p className="text-[10px] mt-1 text-right" style={{ color: form.description.length > 500 ? '#EF4444' : '#64748B', fontFamily: MONO }}>
        ...
        <button onClick={handleSubmit} disabled={loading}
          ...
          style={{ background: '#FF6A00', color: 'white', fontFamily: BODY }}
        ...
        <p className="text-[10px] text-center" style={{ color: '#64748B', fontFamily: MONO }}>
