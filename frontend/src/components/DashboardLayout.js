...
const DashboardLayout = ({ children }) => {
  ...
  const navItems = [
    ...
    { icon: AlertCircle, label: 'Intel Centre', path: '/intel-centre' },
    { type: 'divider', label: 'TOOLS' },
    { icon: Shield, label: 'SOP Generator', path: '/sop-generator' },
    { icon: HelpCircle, label: 'Data Center', path: '/data-center' },
    { type: 'divider', label: 'CONFIGURATION' },
    { icon: Building2, label: 'Intelligence Baseline', path: '/intelligence-baseline' },
    { icon: Building2, label: 'Business DNA', path: '/business-profile' },
    { icon: Plug, label: 'Integrations', path: '/integrations' },
    { icon: Mail, label: 'Email', path: '/connect-email' },
    { icon: Mail, label: 'Email Inbox', path: '/email-inbox' },
    { icon: Calendar, label: 'Calendar', path: '/calendar' },
    { icon: HelpCircle, label: 'Documents', path: '/documents' },
