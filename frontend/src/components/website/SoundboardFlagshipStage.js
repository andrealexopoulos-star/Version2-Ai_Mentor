...
const SoundboardFlagshipStage = () => (
  ...
  >
    ...
    <div className="mb-3 flex items-center gap-2.5">
      ...
      <p className="text-sm sm:text-[15px] font-semibold" style={{ color: 'var(--ink-display, #EDF1F7)', fontFamily: fontFamily.body }}>
        ...
        <div className="space-y-2">
          ...
          <div className="flex justify-center">
            <span
              ...
              style={{ color: 'var(--ink-display, #EDF1F7)', background: 'rgba(198,95,46,0.14)', border: '1px solid rgba(198,95,46,0.3)', fontFamily: fontFamily.mono }}
            >
              Boardroom Mode
          ...
          <div className="mr-auto max-w-[96%] rounded-xl border px-3 py-2.5" style={{ borderColor: 'rgba(198,95,46,0.28)', background: 'rgba(198,95,46,0.08)' }}>
            <div className="flex items-start gap-2">
              ...
              <div className="min-w-0">
                <p className="text-[11px] sm:text-xs mb-1" style={{ color: 'var(--ink-display, #EDF1F7)', fontFamily: fontFamily.body }}>
