        ...
        <div className="inline-flex rounded-xl p-1" style={{ background: 'rgba(15,23,32,0.82)', border: '1px solid rgba(91,143,168,0.25)' }}>
          <button
            ...
            style={{
              ...
              color: activeTab === 'meet' ? 'var(--ink-display, #0A0A0A)' : '#8FA0B8',
          ...
          <button
            ...
            style={{
              fontFamily: fontFamily.body,
              color: activeTab === 'soundboard' ? 'var(--ink-display, #0A0A0A)' : '#8FA0B8',
      ...
      {activeTab === 'meet' ? (
        <div className="space-y-4">
          <div className="text-left rounded-xl border p-4" style={{ borderColor: 'rgba(91,143,168,0.24)', background: 'rgba(15,23,32,0.78)' }}>
            <h3 className="text-xl sm:text-2xl font-semibold mb-3" style={{ color: 'var(--ink-display, #0A0A0A)', fontFamily: fontFamily.display }}>
              How BIQc works
            </h3>
          ...
          <div className="rounded-xl border p-3" style={{ borderColor: 'rgba(91,143,168,0.25)', background: 'rgba(15,23,32,0.82)' }}>
            <div className="space-y-2">
              ...
              <div className="flex justify-center">
                <span className="inline-flex items-center gap-1 rounded-md px-2.5 py-1 text-[10px]" style={{ color: 'var(--ink-display, #0A0A0A)', background: 'rgba(198,95,46,0.14)', border: '1px solid rgba(198,95,46,0.3)', fontFamily: fontFamily.mono }}>
              ...
              <div className="mr-auto max-w-[96%] rounded-xl border px-3 py-2.5" style={{ borderColor: 'rgba(198,95,46,0.28)', background: 'rgba(198,95,46,0.08)' }}>
                <div className="flex items-start gap-2">
                  ...
                  <div className="min-w-0">
                    <p className="text-[11px] sm:text-xs mb-1 leading-relaxed whitespace-pre-line" style={{ color: 'var(--ink-display, #0A0A0A)', fontFamily: fontFamily.body }}>
                      {responseText}
