...
const AILearningGuarantee = () => (
  <div className="min-h-screen" style={{ background: '#0F1720' }}>
    <div className="max-w-3xl mx-auto px-6 py-16">
      <Link to="/trust" className="inline-flex items-center gap-2 mb-10 text-sm transition-colors hover:text-[#FF6A00]" style={{ color: '#64748B', fontFamily: BODY }}>
      ...
      <div className="mb-12">
        <div className="flex items-center gap-3 mb-4">
          ...
          <span className="text-[10px] font-semibold tracking-widest uppercase" style={{ color: '#FF6A00', fontFamily: MONO }}>Data Protection</span>
        </div>
        <h1 className="text-3xl sm:text-4xl font-semibold text-[#F4F7FA] mb-4" style={{ fontFamily: HEAD }}>
          BIQc AI Learning Guarantee
        </h1>
        <p className="text-lg text-[#9FB0C3] leading-relaxed" style={{ fontFamily: BODY }}>
      ...
      <div className="rounded-xl p-6 mb-8" style={{ background: '#141C26', border: '1px solid #243140' }}>
        <h2 className="text-sm font-semibold text-[#F4F7FA] mb-4" style={{ fontFamily: HEAD }}>Our Guarantee</h2>
        <div className="space-y-4">
          {[
            ...
            <div key={i} className="flex items-start gap-3">
              ...
              <p className="text-sm text-[#9FB0C3] leading-relaxed" style={{ fontFamily: BODY }}>{item}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="rounded-xl p-6 mb-8" style={{ background: '#141C26', border: '1px solid #243140' }}>
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-sm font-semibold text-[#F4F7FA]" style={{ fontFamily: HEAD }}>How BIQc Processes Your Data</h2>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
        {[
          ...
          <div key={seg.label} className="rounded-xl p-5" style={{ background: '#141C26', border: '1px solid #243140' }}>
            <span className="text-[10px] font-semibold tracking-widest uppercase block mb-3" style={{ color: '#FF6A00', fontFamily: MONO }}>{seg.label}</span>
            <div className="space-y-2">
              {seg.items.map((item, i) => (
                <p key={i} className="text-xs text-[#9FB0C3]" style={{ fontFamily: BODY }}>{item}</p>
              ))}
            </div>
          </div>
        ))}
