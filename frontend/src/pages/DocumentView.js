        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8">
            <button
              ...
              className="inline-flex items-center gap-2 text-[var(--ink-secondary)] hover:text-[var(--ink-display)] mb-6 transition-colors"
            ...
            <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
              <div>
                ...
                <h1 className="text-3xl md:text-4xl font-serif text-[var(--ink-display)]">{document?.title}</h1>
                <div className="flex items-center gap-4 mt-3 text-sm text-[var(--ink-secondary)]">
              ...
              <div className="flex gap-2">
                ...
                <Button 
                  ...
                  className="border-[rgba(140,170,210,0.15)] text-[var(--ink-display)]"
