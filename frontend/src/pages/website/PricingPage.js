...
const PlanCard = ({ plan }) => (
  <article
    ...
    style={{
      ...
      background: plan.featured ? 'rgba(232,93,0,0.04)' : 'rgba(255,255,255,0.7)',
    }}
  >
    <span
    ...
    <h3 className="text-xl font-semibold mb-1 break-words" style={{ fontFamily: fontFamily.display, color: 'var(--ink-display, #0A0A0A)' }}>
      {plan.name}
    </h3>
    ...
    <p className="text-sm mb-5 break-words" style={{ color: 'var(--ink-secondary, #6B7280)', fontFamily: fontFamily.body }}>
      {plan.summary}
    </p>
    ...
    <WebsiteLayout>
      <section className="pt-16 sm:pt-24 pb-10 px-6 text-center">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-4xl sm:text-5xl font-semibold mb-4" style={{ fontFamily: fontFamily.display, color: 'var(--ink-display, #0A0A0A)' }}>
            Same core intelligence, choose your capacity.
          </h1>
          <p className="text-base sm:text-lg" style={{ color: 'var(--ink-secondary, #6B7280)', fontFamily: fontFamily.body }}>
      ...
      <section className="px-6 pb-12">
        <div className="max-w-[980px] mx-auto rounded-2xl p-6" style={{ border: '1px solid rgba(140,170,210,0.16)', background: 'rgba(248,250,252,0.8)' }}>
          <p className="text-xs uppercase tracking-[0.08em] font-semibold mb-2" style={{ fontFamily: fontFamily.mono, color: '#E85D00' }}>
            Top-up at launch hold
          </p>
          <h2 className="text-xl font-semibold mb-2" style={{ fontFamily: fontFamily.display, color: 'var(--ink-display, #0A0A0A)' }}>
            Top-up is informational only right now.
          </h2>
          <p className="text-sm mb-3" style={{ color: 'var(--ink-secondary, #6B7280)', fontFamily: fontFamily.body }}>
      ...
      <section className="py-12 px-4 sm:px-6" style={{ borderTop: '1px solid rgba(140,170,210,0.16)' }}>
        <div className="max-w-[1100px] mx-auto">
          <div className="text-center mb-6">
            <h2 className="text-2xl sm:text-3xl font-semibold mb-2" style={{ fontFamily: fontFamily.display, color: 'var(--ink-display, #0A0A0A)' }}>
              Plan comparison
            </h2>
            <button
              type="button"
              ...
              style={{ border: '1px solid rgba(140,170,210,0.2)', color: 'var(--ink-display, #0A0A0A)', fontFamily: fontFamily.body }}
            >
      ...
      <section className="py-12 px-6" style={{ borderTop: '1px solid rgba(140,170,210,0.16)' }}>
        <div className="max-w-4xl mx-auto rounded-2xl p-6" style={{ background: 'rgba(232,93,0,0.05)', border: '1px solid rgba(232,93,0,0.2)' }}>
          <h2 className="text-2xl font-semibold mb-2" style={{ fontFamily: fontFamily.display, color: 'var(--ink-display, #0A0A0A)' }}>
      ...
      <section className="py-14 px-6" style={{ borderTop: '1px solid rgba(140,170,210,0.16)' }}>
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl sm:text-3xl font-semibold mb-5" style={{ fontFamily: fontFamily.display, color: 'var(--ink-display, #0A0A0A)' }}>
