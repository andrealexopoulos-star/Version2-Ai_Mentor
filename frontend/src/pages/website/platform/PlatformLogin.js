    ...
    <div className="flex-1 flex items-center justify-center px-6 py-12">
      <div className="w-full max-w-sm">
        ...
        <div className="space-y-3 mb-6">
          <Link to="/login-supabase" className="w-full flex items-center justify-center gap-2.5 px-4 py-2.5 rounded-lg text-sm font-medium text-[#EDF1F7] transition-colors hover:bg-white/10" style={{ fontFamily: fontFamily.body, background: 'var(--surface, #0E1628)', border: '1px solid rgba(140,170,210,0.15)' }} data-testid="google-login">
      ...
      <div className="max-w-sm">
        ...
        <div className="space-y-3">
          {[
            ...
            <div key={item.label} className="flex items-center gap-3 px-4 py-3 rounded-lg" style={{ background: 'var(--surface, #0E1628)', border: '1px solid rgba(140,170,210,0.15)' }}>
