    ...
    <div className="flex-1 flex items-center justify-center px-6 py-12">
      <div className="w-full max-w-sm">
        ...
        <div className="space-y-3 mb-6">
          <Link to="/login-supabase" className="w-full flex items-center justify-center gap-2.5 px-4 py-2.5 rounded-lg text-sm font-medium text-[#EDF1F7] transition-colors hover:bg-white/10" style={{ fontFamily: fontFamily.body, background: 'var(--surface, #FFFFFF)', border: '1px solid rgba(140,170,210,0.15)' }} data-testid="google-login">
          ...
          <Link to="/login-supabase" className="w-full flex items-center justify-center gap-2.5 px-4 py-2.5 rounded-lg text-sm font-medium text-[#EDF1F7] transition-colors hover:bg-white/10" style={{ fontFamily: fontFamily.body, background: 'var(--surface, #FFFFFF)', border: '1px solid rgba(140,170,210,0.15)' }} data-testid="microsoft-login">
        ...
        <Link to="/login-supabase" className="w-full flex items-center justify-center px-4 py-3 rounded-lg text-sm font-semibold text-white transition-all hover:brightness-110" style={{ background: '#E85D00', fontFamily: fontFamily.display }} data-testid="signin-btn">
          Sign in
        </Link>

        <p className="text-xs text-[#64748B] text-center mt-4" style={{ fontFamily: fontFamily.body }}>
          Don't have an account? <Link to="/register-supabase" className="text-[#E85D00] font-medium">Get started</Link>
        </p>
      </div>
    </div>
      ...
      <div className="max-w-sm">
        ...
        <div className="space-y-3">
          {[
            ...
            <div key={item.label} className="flex items-center gap-3 px-4 py-3 rounded-lg" style={{ background: 'var(--surface, #FFFFFF)', border: '1px solid rgba(140,170,210,0.15)' }}>
              <item.icon className="w-4 h-4 text-[#E85D00] shrink-0" />
              <div>
                <span className="text-sm font-medium text-[#EDF1F7] block" style={{ fontFamily: fontFamily.display }}>{item.label}</span>
