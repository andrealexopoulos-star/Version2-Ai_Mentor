      ...
      <div className="w-full max-w-sm">
        ...
        <div className="flex items-center gap-2.5 mb-10">
          ...
          <div>
            ...
            <span className="text-[10px] text-[#64748B]" style={{ fontFamily: fontFamily.mono }}>powered by The Strategy Squad</span>
          </div>
        </div>
        ...
        <div className="space-y-3 mb-6">
          <button className="w-full flex items-center justify-center gap-2.5 px-4 py-2.5 rounded-lg text-sm font-medium text-[#F4F7FA] transition-colors hover:bg-white/10" style={{ fontFamily: fontFamily.body, background: '#141C26', border: '1px solid #243140' }} data-testid="google-login">
          ...
          <button className="w-full flex items-center justify-center gap-2.5 px-4 py-2.5 rounded-lg text-sm font-medium text-[#F4F7FA] transition-colors hover:bg-white/10" style={{ fontFamily: fontFamily.body, background: '#141C26', border: '1px solid #243140' }} data-testid="microsoft-login">
        ...
        <div className="space-y-4 mb-6">
          <div>
            ...
            <input type="email" defaultValue="andre@thestrategysquad.com.au" className="w-full px-3.5 py-2.5 rounded-lg text-sm text-[#F4F7FA] outline-none transition-all focus:border-[#FF6A00]" style={{ fontFamily: fontFamily.body, background: '#0A1018', border: '1px solid #243140' }} data-testid="email-input" />
          </div>
          <div>
            <label className="text-xs font-medium text-[#9FB0C3] block mb-1.5" style={{ fontFamily: fontFamily.body }}>PASSWORD</label>
            <input type="password" defaultValue="••••••••••" className="w-full px-3.5 py-2.5 rounded-lg text-sm text-[#F4F7FA] outline-none transition-all focus:border-[#FF6A00]" style={{ fontFamily: fontFamily.body, background: '#0A1018', border: '1px solid #243140' }} data-testid="password-input" />
          </div>
        </div>

        <Link to="/platform/overview" className="w-full flex items-center justify-center px-4 py-3 rounded-lg text-sm font-semibold text-white transition-all hover:brightness-110" style={{ background: '#FF6A00', fontFamily: fontFamily.display }} data-testid="signin-btn">
          Sign in
        </Link>
