...
const AutomationCard = ({ auto }) => (
  <div className="rounded-lg overflow-hidden" style={{ background: '#0E1628', border: `1px solid ${auto.active ? 'rgba(140,170,210,0.15)' : 'rgba(140,170,210,0.15)'}`, opacity: auto.active ? 1 : 0.7 }} data-testid={`automation-${auto.id}`}>
