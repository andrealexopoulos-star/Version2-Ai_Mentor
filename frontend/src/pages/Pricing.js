  ...
  const plans = [
    {
      ...
      price: 'Free',
      period: 'forever',
      description: 'See what BIQc sees about your business. No credit card required.',
      highlight: false,
      features: [
        { text: 'Digital Footprint Scan (13 layers)', included: true },
        { text: 'Executive Intelligence Snapshot', included: true },
        { text: 'Identity Verification & Confidence', included: true },
        { text: 'Market Position Assessment', included: true },
        { text: 'Competitor Landscape (public signals)', included: true },
        { text: 'SoundBoard Chat (10 messages/month)', included: true },
        { text: 'System State Monitoring', included: true },
        { text: 'Data Gaps & Confidence Reporting', included: true },
        { text: 'Forensic Calibration', included: false },
        { text: 'CRM/Accounting Integration', included: false },
      ],
      cta: 'Try It For Free',
      ctaVariant: 'outline'
    },
    {
      ...
      price: '$49',
      period: '/month',
      description: 'Full cognition platform with integrations and deep modelling.',
      highlight: true,
      badge: 'Most Popular',
      features: [
        { text: 'Everything in Free', included: true },
        { text: 'Unlimited SoundBoard Chat', included: true },
        { text: 'CRM Integration (HubSpot, Salesforce)', included: true },
        { text: 'Accounting Integration (Xero, QuickBooks)', included: true },
        { text: 'Email Intelligence (Outlook, Gmail)', included: true },
        { text: 'Forensic Business Calibration', included: true },
        { text: '90-Day Trajectory Projection', included: true },
        { text: 'Prediction Tracking & Accuracy', included: true },
        { text: 'Workforce & Growth Modelling', included: true },
        { text: 'Weekly Intelligence Digest', included: true },
      ],
