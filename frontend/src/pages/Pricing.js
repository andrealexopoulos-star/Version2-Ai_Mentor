  ...
  const plans = [
    {
      ...
      price: 'Free',
      period: 'forever',
      description: 'Perfect for exploring Personalised AI Business Advisory.',
      highlight: false,
      features: [
        { text: '10 AI advisory messages/month', included: true },
    ...
    },
    {
      ...
      price: '$29',
      period: '/month',
      description: 'Full Personalised AI Advisory for serious growth.',
      highlight: true,
      badge: 'Most Popular',
      features: [
        { text: 'Unlimited AI advisory messages', included: true },
