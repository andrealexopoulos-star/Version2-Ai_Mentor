...
const CompliancePage = () => {
  ...
  return (
    <DashboardLayout>
      <div className="space-y-6 max-w-[1200px]" style={{ fontFamily: BODY }} data-testid="compliance-page">
        <div>
          <h1 className="text-2xl font-semibold text-[#F4F7FA] mb-1" style={{ fontFamily: HEAD }}>Compliance Intelligence</h1>
        ...
        {!loading && (
          <>
            ...
            {(risk.spof || []).length > 0 && (
              <Panel>
                <h3 className="text-sm font-semibold text-[#F4F7FA] mb-3" style={{ fontFamily: HEAD }}>Single Points of Failure</h3>
            ...
            {regulatory.length > 0 ? (
              <Panel>
                <h3 className="text-sm font-semibold text-[#F4F7FA] mb-3" style={{ fontFamily: HEAD }}>Regulatory Obligations</h3>
                <div className="space-y-2">
                  {regulatory.map((r, i) => (
                    <div key={i} className="flex items-center gap-3 p-3 rounded-lg" style={{ background: '#0F1720', border: '1px solid #243140' }}>
                      ...
                      <span className="text-[10px] px-2 py-0.5 rounded" style={{ color: r.sev === 'med' ? '#F59E0B' : '#10B981', background: (r.sev === 'med' ? '#F59E0B' : '#10B981') + '15', fontFamily: MONO }}>{r.sev}</span>
                    </div>
                  ))}
                </div>
              </Panel>
            ...
            {risk.concentration && (
              <Panel>
                <h3 className="text-[10px] font-semibold tracking-widest uppercase mb-2" style={{ color: '#64748B', fontFamily: MONO }}>Revenue Concentration Risk</h3>
            ...
            {alignment.narrative && (
              <Panel>
                <h3 className="text-[10px] font-semibold tracking-widest uppercase mb-2" style={{ color: '#F59E0B', fontFamily: MONO }}>Strategic Alignment</h3>
