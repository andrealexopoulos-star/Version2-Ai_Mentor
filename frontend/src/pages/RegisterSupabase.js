      ...
      <div className="flex-1 flex flex-col justify-center px-8 md:px-16 lg:px-24 py-12 bg-white">
        <div className="max-w-md w-full mx-auto">
          ...
          <div className="mb-10">
            ...
            <p className="text-gray-500">Create your account to access AI-powered business insights</p>
          </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-600">
              ...
              <Link to="/login-supabase" className="text-blue-600 hover:text-blue-700 font-semibold transition-colors">
                Sign in
              </Link>
            </p>
          </div>
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-blue-600 via-blue-700 to-blue-900 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-md">
            Join forward-thinking business leaders leveraging AI-powered insights for strategic advantage.
          </p>
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-lg">Real-time business intelligence</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 bg-white/20 rounded-lg flex items-center justify-center">
                <Zap className="w-4 h-4" />
              </div>
              <span className="text-lg">Personalized strategic recommendations</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 bg-white/20 rounded-lg flex items-center justify-center">
                <Zap className="w-4 h-4" />
              </div>
              <span className="text-lg">Voice-enabled AI thinking partner</span>
            </div>
          </div>
        </div>
      </div>
