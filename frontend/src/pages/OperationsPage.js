...
import { Settings, Clock, Users, AlertTriangle, CheckCircle2, ArrowUpRight, ArrowDownRight, Workflow } from 'lucide-react';
  ...
  <DashboardLayout>
    <div className="space-y-6 max-w-[1200px]" style={{ fontFamily: INTER }} data-testid="operations-page">
      <div>
        ...
        <p className="text-sm text-[#9FB0C3]">Task execution, SOP compliance, bottlenecks, and delivery performance.</p>
      </div>

      {/* KPI Strip */}
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          { label: 'SOP Compliance', value: '87%', color: '#10B981', icon: CheckCircle2 },
          { label: 'SLA Breaches', value: '2', color: '#FF6A00', icon: AlertTriangle },
          { label: 'Tasks Active', value: '14', color: '#3B82F6', icon: Workflow },
