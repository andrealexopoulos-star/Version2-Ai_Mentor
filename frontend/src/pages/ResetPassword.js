  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-x-hidden" style={{ background: '#080C14' }}>
      ...
      <nav className="relative z-10 flex items-center justify-between px-6 sm:px-10 py-6">
        ...
        <Link to="/login-supabase" className="text-sm px-4 py-2 rounded-lg transition-colors" style={{ color: 'var(--ink-secondary, #8FA0B8)', fontFamily: fontFamily.body }} data-testid="reset-back-link">
          ← Back to sign in
        </Link>
      </nav>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 relative z-10">
        <div className="w-full max-w-[480px]">
          <div className="rounded-2xl p-10" style={{ background: 'var(--surface, #0E1628)', border: '1px solid rgba(140,170,210,0.12)', boxShadow: '0 12px 40px rgba(0,0,0,0.4)' }} data-testid="reset-card">
            {sent ? (
              <div className="text-center" data-testid="reset-sent">
                ...
                <p className="text-sm leading-relaxed mb-6" style={{ fontFamily: fontFamily.body, color: 'var(--ink-secondary, #8FA0B8)' }}>
                ...
                <p className="text-xs mb-6" style={{ fontFamily: fontFamily.mono, color: 'var(--ink-muted, #708499)' }}>Didn't receive it? Check spam or try again.</p>
              ...
              <>
                ...
                <h1 className="font-semibold mb-3" style={{ fontFamily: DISPLAY, color: 'var(--ink-display, #EDF1F7)', fontSize: '40px', letterSpacing: '-0.02em', lineHeight: 1.05 }}>
                  Reset your <em style={{ fontStyle: 'italic', color: '#E85D00' }}>password</em>.
                </h1>
                <p className="text-base leading-relaxed" style={{ fontFamily: fontFamily.body, color: 'var(--ink-secondary, #8FA0B8)' }}>
                ...
                <form onSubmit={handleReset} data-testid="reset-form">
                  <div className="flex flex-col gap-1.5 mt-7">
                    <label htmlFor="reset-email" className="text-[10px] font-medium uppercase tracking-[0.08em]" style={{ fontFamily: fontFamily.mono, color: 'var(--ink-muted, #708499)' }}>Work email</label>
                ...
                <p className="text-sm mt-6 text-center" style={{ fontFamily: fontFamily.body, color: 'var(--ink-secondary, #8FA0B8)' }}>
                  Remembered it?{' '}
          ...
          {/* SSO info aside */}
          <div className="flex items-start gap-4 mt-6 p-5 rounded-xl" style={{ background: 'var(--surface-2, #121D30)', border: '1px solid rgba(140,170,210,0.12)' }}>
            ...
            <p className="text-[13px] leading-relaxed" style={{ fontFamily: fontFamily.body, color: 'var(--ink-secondary, #8FA0B8)' }}>
