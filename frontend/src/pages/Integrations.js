  ...
  return (
    <DashboardLayout>
      <style>{`
        ...
        .int-card:hover { transform: translateY(-3px); box-shadow: var(--elev-2); border-color: var(--lava) !important; }
      `}</style>

      <div style={{ background: 'var(--canvas-app)', minHeight: '100%', fontFamily: 'var(--font-ui)' }}>
        <div className="max-w-[1140px] mx-auto px-4 sm:px-6 py-8">
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
              <div>
                ...
                <h1 className="font-medium" style={{ fontFamily: 'var(--font-display)', color: 'var(--ink-display)', fontSize: 'clamp(1.8rem, 3vw, 2.4rem)', letterSpacing: '-0.02em', lineHeight: 1.05 }}>
              ...
              <button
                ...
                style={{ border: '1px solid var(--border)', color: 'var(--ink-display)', background: 'var(--surface)' }}
            ...
            <div className="grid grid-cols-1 gap-2.5 lg:grid-cols-[1fr_210px]">
              <div className="relative">
                ...
                />
                {searchTerm && (
                  <button type="button" onClick={() => setSearchTerm('')} className="absolute right-3 top-1/2 -translate-y-1/2" style={{ color: 'var(--ink-muted)' }}>
                    <X className="w-4 h-4" />
                  </button>
                )}
              </div>
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <span className="ml-auto text-[11px]" style={{ color: 'var(--ink-muted)', fontFamily: 'var(--font-mono)' }}>
          ...
          <button
            ...
            style={{ border: '1px dashed var(--border)', color: 'var(--ink-secondary)', background: 'var(--surface)', fontFamily: 'var(--font-ui)' }}
...
function IntCard({ integration, index, connected, connectedLabel, disconnecting, openingMerge, onConnect, onDisconnect, badge, comingSoon, isStale = false, truthState = 'unverified', truthReason = '' }) {
  const statusTone = connected
    ...
    : comingSoon
      ? { text: 'var(--warning)', bg: 'var(--warning-wash)' }
  ...
  return (
    <div
      className="int-card border transition-all"
      style={{
        background: 'var(--surface)',
        borderColor: connected ? 'var(--positive)' : 'var(--border)',
        ...
        <div className="flex items-center gap-1.5">
          {connected ? (
            ...
            <>
              ...
              <span className="text-[10px] font-semibold uppercase" style={{ color: 'var(--ink-muted)', fontFamily: 'var(--font-mono)', letterSpacing: 'var(--ls-caps)' }}>
