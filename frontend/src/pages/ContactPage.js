...
export default function ContactPage() {
  ...
  return (
    <WebsiteLayout>
          ...
          <div className="grid lg:grid-cols-5 gap-8 items-start">
            ...
            <div className="lg:col-span-3 rounded-xl p-9"
              ...
              {submitted ? (
                <div className="text-center py-8" data-testid="contact-success">
                  ...
                  <h2 className="text-xl font-bold mb-2" style={{ color: 'var(--ink-display)' }}>
                ...
                <form onSubmit={handleSubmit} className="space-y-5" data-testid="contact-form">
                  <div>
                    <label className="block text-sm font-medium mb-1.5" style={{ color: 'var(--ink-display)' }}>Full Name</label>
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-1.5" style={{ color: 'var(--ink-display)' }}>Work Email</label>
                    <input type="email" required value={form.email} onChange={(e) => update('email', e.target.value)}
                      className="w-full rounded-lg px-3.5 py-2.5 text-sm outline-none transition-all focus:ring-2 focus:ring-[#E85D00]/20 focus:border-[#E85D00]"
                      style={inputStyle} placeholder="you@company.com" data-testid="contact-email" />
                  </div>
                  <div>
                    <label className="block text-sm font-medium mb-1.5" style={{ color: 'var(--ink-display)' }}>Company Name</label>
                  ...
                  {(isWaitlist || isCustomConnector) && (
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        <label className="block text-sm font-medium mb-1.5" style={{ color: 'var(--ink-display)' }}>Feature Interest *</label>
                      ...
                      <div>
                        <label className="block text-sm font-medium mb-1.5" style={{ color: 'var(--ink-display)' }}>Business Size *</label>
                  ...
                  {!isWaitlist && !isCustomConnector && (
                    <div>
                      <label className="block text-sm font-medium mb-1.5" style={{ color: 'var(--ink-display)' }}>Subject</label>
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-1.5" style={{ color: 'var(--ink-display)' }}>Message</label>
                  ...
                  <button type="submit" disabled={submitting}
                    ...
                    style={{ background: 'var(--lava)' }} data-testid="contact-submit">
            ...
            <div className="lg:col-span-2 flex flex-col gap-5">
              ...
              <div className="rounded-xl p-7"
                ...
                {[
                  ...
                  <div key={item.label} className="flex items-start gap-3 mb-4 last:mb-0">
                    ...
                    <div>
                      <div className="text-[13px] mb-0.5" style={{ color: 'var(--ink-secondary)' }}>{item.label}</div>
                      <div className="text-sm font-medium" style={{ color: 'var(--ink-display)' }}>{item.value}</div>
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div className="rounded-xl p-7"
                ...
                <h4 className="text-[15px] font-semibold mb-2" style={{ color: 'var(--ink-display)' }}>Looking for support?</h4>
          ...
          <div className="rounded-xl overflow-hidden grid md:grid-cols-2 min-h-[280px]"
            ...
            <div className="flex flex-col items-center justify-center py-10 px-10 relative"
              ...
              <div className="w-12 h-12 rounded-full rounded-bl-none rotate-[-45deg] flex items-center justify-center mb-5"
                style={{ background: 'var(--lava)', boxShadow: '0 4px 12px rgba(232,93,0,0.2)' }}>
                <div className="w-[18px] h-[18px] rounded-full rotate-45" style={{ background: 'var(--surface)' }} />
              </div>
              <div className="text-lg font-semibold" style={{ color: 'var(--ink-display)' }}>Sydney, Australia</div>
              <div className="text-sm mt-1" style={{ color: 'var(--ink-secondary)' }}>Headquarters</div>
            </div>
            {/* Map Info */}
            <div className="flex flex-col justify-center py-10 px-10">
              ...
              {[
                ...
                <div key={i} className="flex items-center gap-2 mb-2 text-sm" style={{ color: 'var(--ink)' }}>
      ...
      {/* Bottom CTA */}
      <section className="py-24 px-6 text-center" style={{ background: 'var(--canvas)' }}>
        <div className="max-w-2xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-4" style={{ color: 'var(--ink-display)' }}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/register"
              ...
              style={{ background: 'var(--lava)', boxShadow: '0 4px 16px rgba(232,93,0,0.3)' }}>
