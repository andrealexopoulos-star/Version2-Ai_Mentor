...
```env
REACT_APP_BACKEND_URL=https://inbox-sync-3.preview.emergentagent.com
...
```
https://inbox-sync-3.preview.emergentagent.com/email-inbox
```
...
- [ ] Redirect URI added: `https://inbox-sync-3.preview.emergentagent.com/api/auth/outlook/callback`
...
- [ ] Redirect URI added: `https://inbox-sync-3.preview.emergentagent.com/api/auth/gmail/callback`
...
1. Navigate to: `https://inbox-sync-3.preview.emergentagent.com/connect-email`
