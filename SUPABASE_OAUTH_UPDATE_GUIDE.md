...
**Current Fork URL:** `https://html-bug-fixed.preview.emergentagent.com`  
**Previous URL:** `https://html-bug-fixed.preview.emergentagent.com`  
...
const redirectUrl = 'https://html-bug-fixed.preview.emergentagent.com/integrations';
...
1. Open: `https://html-bug-fixed.preview.emergentagent.com`
...
// ❌ BAD: Hardcoded
const redirectUrl = 'https://html-bug-fixed.preview.emergentagent.com';
```
...
### ✅ Should Work:
1. Navigate to: `https://html-bug-fixed.preview.emergentagent.com`
2. Click: "Sign in with Microsoft"
