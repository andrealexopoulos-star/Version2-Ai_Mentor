...
**Current Fork URL:** `https://business-iq-1.preview.emergentagent.com`  
**Previous URL:** `https://advisor-chat-1.preview.emergentagent.com`  
...
```
https://business-iq-1.preview.emergentagent.com/auth/callback
...
const redirectUrl = 'https://advisor-chat-1.preview.emergentagent.com/integrations';
...
1. Open: `https://business-iq-1.preview.emergentagent.com`
...
// ❌ BAD: Hardcoded
const redirectUrl = 'https://advisor-chat-1.preview.emergentagent.com';
```
...
### ✅ Should Work:
1. Navigate to: `https://business-iq-1.preview.emergentagent.com`
2. Click: "Sign in with Microsoft"
...
```
https://advisor-chat-1.preview.emergentagent.com/auth/callback
https://advisor-chat-1.preview.emergentagent.com/**
https://business-iq-1.preview.emergentagent.com/auth/callback
https://business-iq-1.preview.emergentagent.com/**
```
