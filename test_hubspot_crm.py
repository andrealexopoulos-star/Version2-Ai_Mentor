...
# Test configuration
BASE_URL = "https://watchtower-ai.preview.emergentagent.com/api"
...
def main():
    ...
    if not token:
        ...
        print("")
        print("   // Test Contacts")
        print("   fetch('https://watchtower-ai.preview.emergentagent.com/api/integrations/crm/contacts', {")
        ...
        print("   fetch('https://watchtower-ai.preview.emergentagent.com/api/integrations/crm/companies', {")
        print("     headers: {'Authorization': 'Bearer ' + JSON.parse(localStorage.getItem('sb-uxyqpdfftxpkzeppqtvk-auth-token')).access_token}")
        print("   }).then(r => r.json()).then(console.log)")
        print("")
        print("   // Test Deals")
        print("   fetch('https://watchtower-ai.preview.emergentagent.com/api/integrations/crm/deals', {")
        print("     headers: {'Authorization': 'Bearer ' + JSON.parse(localStorage.getItem('sb-uxyqpdfftxpkzeppqtvk-auth-token')).access_token}")
        print("   }).then(r => r.json()).then(console.log)")
        print("")
        print("   // Test Owners")
        print("   fetch('https://watchtower-ai.preview.emergentagent.com/api/integrations/crm/owners', {")
        print("     headers: {'Authorization': 'Bearer ' + JSON.parse(localStorage.getItem('sb-uxyqpdfftxpkzeppqtvk-auth-token')).access_token}")
        print("   }).then(r => r.json()).then(console.log)")
        return 1
