...
**Working URL:** `https://intel-pipeline.preview.emergentagent.com`
...
**Active URL:** `https://intel-pipeline.preview.emergentagent.com`

**Environment Variables:**
```
REACT_APP_BACKEND_URL=https://intel-pipeline.preview.emergentagent.com
...
**USE ONLY:** `https://intel-pipeline.preview.emergentagent.com`
...
**CAN USE:** `https://intel-pipeline.preview.emergentagent.com` (this fork)
...
```
Frontend: https://intel-pipeline.preview.emergentagent.com
Backend: https://intel-pipeline.preview.emergentagent.com/api
...
- **YOU MUST USE:** `https://intel-pipeline.preview.emergentagent.com`
