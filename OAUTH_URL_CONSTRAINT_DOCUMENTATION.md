...
**Working URL:** `https://advisor-chat-1.preview.emergentagent.com`
...
**Active URL:** `https://business-iq-1.preview.emergentagent.com`

**Environment Variables:**
```
REACT_APP_BACKEND_URL=https://business-iq-1.preview.emergentagent.com
FRONTEND_URL=https://business-iq-1.preview.emergentagent.com
BACKEND_URL=https://business-iq-1.preview.emergentagent.com
```
...
**USE ONLY:** `https://advisor-chat-1.preview.emergentagent.com`

**Workflow:**
1. Navigate to: `https://advisor-chat-1.preview.emergentagent.com`
...
**CAN USE:** `https://business-iq-1.preview.emergentagent.com` (this fork)
...
```
Frontend: https://business-iq-1.preview.emergentagent.com
Backend: https://business-iq-1.preview.emergentagent.com/api
...
```
Frontend: https://advisor-chat-1.preview.emergentagent.com
Backend: https://advisor-chat-1.preview.emergentagent.com/api
Database: Supabase (shared)
Auth: Supabase (shared)
OAuth: Configured ✅
```
...
- **YOU MUST USE:** `https://advisor-chat-1.preview.emergentagent.com`
