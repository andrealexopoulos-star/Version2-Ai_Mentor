...
DO $$ BEGIN ALTER FUNCTION ic_index_dominance_analysis() SET search_path = ''; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER FUNCTION get_escalation_summary(UUID) SET search_path = ''; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER FUNCTION detect_silence(UUID) SET search_path = ''; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER FUNCTION is_spine_enabled() SET search_path = ''; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER FUNCTION ic_calculate_all_risk_baselines() SET search_path = ''; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER FUNCTION compute_pressure_levels(UUID) SET search_path = ''; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER FUNCTION increment_audit_counter(UUID) SET search_path = ''; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER FUNCTION ab_experiment_results(TEXT) SET search_path = ''; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER FUNCTION ic_resolve_industry_code(TEXT) SET search_path = ''; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER FUNCTION compute_data_readiness(UUID) SET search_path = ''; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER FUNCTION emergency_delete_governance_event(UUID, TEXT) SET search_path = ''; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER FUNCTION build_intelligence_summary(UUID) SET search_path = ''; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER FUNCTION trigger_log_integration_change() SET search_path = ''; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER FUNCTION ic_calculate_risk_baseline(UUID, UUID) SET search_path = ''; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER FUNCTION ab_get_variant(TEXT, UUID) SET search_path = ''; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER FUNCTION ic_process_event_queue() SET search_path = ''; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER FUNCTION compute_evidence_freshness(UUID) SET search_path = ''; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER FUNCTION compute_watchtower_positions(UUID) SET search_path = ''; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER FUNCTION detect_contradictions(UUID) SET search_path = ''; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER FUNCTION ic_generate_all_snapshots() SET search_path = ''; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER FUNCTION ic_generate_daily_snapshot(UUID) SET search_path = ''; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER FUNCTION compute_concentration_risk(UUID) SET search_path = ''; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER FUNCTION ic_risk_calibration_report() SET search_path = ''; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER FUNCTION compute_revenue_scenarios(UUID) SET search_path = ''; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER FUNCTION admin_update_subscription(UUID, UUID, TEXT) SET search_path = ''; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER FUNCTION admin_toggle_user(UUID, UUID, BOOLEAN) SET search_path = ''; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER FUNCTION admin_list_users() SET search_path = ''; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER FUNCTION compute_workforce_health(UUID) SET search_path = ''; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER FUNCTION compute_insight_scores(UUID) SET search_path = ''; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER FUNCTION compute_profile_completeness(UUID) SET search_path = ''; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER FUNCTION increment_snapshot_counter(UUID) SET search_path = ''; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER FUNCTION emit_governance_event(UUID, TEXT, TEXT, TEXT, NUMERIC) SET search_path = ''; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER FUNCTION trigger_update_integration_sync() SET search_path = ''; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER FUNCTION trigger_log_report_export() SET search_path = ''; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER FUNCTION prevent_governance_update() SET search_path = ''; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER FUNCTION ic_prevent_weight_update() SET search_path = ''; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER FUNCTION ic_validate_snapshot_correlation(UUID) SET search_path = ''; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER FUNCTION rag_search(UUID, vector, INT, TEXT[], FLOAT) SET search_path = ''; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER FUNCTION reset_monthly_counters() SET search_path = ''; EXCEPTION WHEN OTHERS THEN NULL; END $$;
