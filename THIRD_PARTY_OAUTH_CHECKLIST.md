...
- [ ] Redirect URI:
  - Platform: **Web**
  - URI: `https://biqc-integrity.preview.emergentagent.com/api/auth/outlook/callback`
...
- [ ] Confirm redirect URI is: `https://biqc-integrity.preview.emergentagent.com/api/auth/outlook/callback`
...
- [ ] Confirm Site URL: `https://biqc-integrity.preview.emergentagent.com`
- [ ] Confirm Redirect URLs include: `https://biqc-integrity.preview.emergentagent.com/auth/callback`
...
✅ **Backend URL:** `https://biqc-integrity.preview.emergentagent.com`
✅ **Frontend URL:** `https://biqc-integrity.preview.emergentagent.com`
