...
- [ ] Redirect URI:
  - Platform: **Web**
  - URI: `https://biqc-auth-edge.preview.emergentagent.com/api/auth/outlook/callback`
...
- [ ] Confirm redirect URI is: `https://biqc-auth-edge.preview.emergentagent.com/api/auth/outlook/callback`
...
- [ ] Confirm Site URL: `https://biqc-auth-edge.preview.emergentagent.com`
- [ ] Confirm Redirect URLs include: `https://biqc-auth-edge.preview.emergentagent.com/auth/callback`
...
✅ **Backend URL:** `https://biqc-auth-edge.preview.emergentagent.com`
✅ **Frontend URL:** `https://biqc-auth-edge.preview.emergentagent.com`
