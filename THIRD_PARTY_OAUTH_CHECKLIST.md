...
- [ ] Redirect URI:
  - Platform: **Web**
  - URI: `https://intel-pipeline.preview.emergentagent.com/api/auth/outlook/callback`
...
- [ ] Confirm redirect URI is: `https://intel-pipeline.preview.emergentagent.com/api/auth/outlook/callback`
...
- [ ] Confirm Site URL: `https://intel-pipeline.preview.emergentagent.com`
- [ ] Confirm Redirect URLs include: `https://intel-pipeline.preview.emergentagent.com/auth/callback`
...
✅ **Backend URL:** `https://intel-pipeline.preview.emergentagent.com`
✅ **Frontend URL:** `https://intel-pipeline.preview.emergentagent.com`
