...
- [ ] Redirect URI:
  - Platform: **Web**
  - URI: `https://auth-loop-fix-4.preview.emergentagent.com/api/auth/outlook/callback`
...
- [ ] Confirm redirect URI is: `https://auth-loop-fix-4.preview.emergentagent.com/api/auth/outlook/callback`
...
- [ ] Confirm Site URL: `https://auth-loop-fix-4.preview.emergentagent.com`
- [ ] Confirm Redirect URLs include: `https://auth-loop-fix-4.preview.emergentagent.com/auth/callback`
...
✅ **Backend URL:** `https://auth-loop-fix-4.preview.emergentagent.com`
✅ **Frontend URL:** `https://auth-loop-fix-4.preview.emergentagent.com`
