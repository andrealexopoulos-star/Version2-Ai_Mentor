...
|---------|-------|--------|
| **Site URL** | `https://executive-reveal.preview.emergentagent.com` | ⏳ Verify |
...
- [x] Site URL: `https://executive-reveal.preview.emergentagent.com`
- [ ] **ADD** Redirect URL: `https://executive-reveal.preview.emergentagent.com/auth/callback`
- [ ] **ADD** Redirect URL: `https://executive-reveal.preview.emergentagent.com/**`
...
Auth Callback: https://executive-reveal.preview.emergentagent.com/auth/callback
```
