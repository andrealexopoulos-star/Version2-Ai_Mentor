...
|---------|-------|--------|
| **Site URL** | `https://stability-verify.preview.emergentagent.com` | ⏳ Verify |
...
- [x] Site URL: `https://stability-verify.preview.emergentagent.com`
- [ ] **ADD** Redirect URL: `https://stability-verify.preview.emergentagent.com/auth/callback`
- [ ] **ADD** Redirect URL: `https://stability-verify.preview.emergentagent.com/**`
...
Auth Callback: https://stability-verify.preview.emergentagent.com/auth/callback
```
