...
|---------|-------|--------|
| **Site URL** | `https://intel-pipeline.preview.emergentagent.com` | ⏳ Verify |
...
- [x] Site URL: `https://intel-pipeline.preview.emergentagent.com`
- [ ] **ADD** Redirect URL: `https://intel-pipeline.preview.emergentagent.com/auth/callback`
- [ ] **ADD** Redirect URL: `https://intel-pipeline.preview.emergentagent.com/**`
...
Auth Callback: https://intel-pipeline.preview.emergentagent.com/auth/callback
```
