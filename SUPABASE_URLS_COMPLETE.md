...
|---------|-------|--------|
| **Site URL** | `https://html-bug-fixed.preview.emergentagent.com` | ⏳ Verify |
...
- [x] Site URL: `https://html-bug-fixed.preview.emergentagent.com`
- [ ] **ADD** Redirect URL: `https://html-bug-fixed.preview.emergentagent.com/auth/callback`
- [ ] **ADD** Redirect URL: `https://html-bug-fixed.preview.emergentagent.com/**`
...
Auth Callback: https://html-bug-fixed.preview.emergentagent.com/auth/callback
```
