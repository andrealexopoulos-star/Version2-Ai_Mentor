...
|---------|-------|--------|
| **Site URL** | `https://inbox-sync-3.preview.emergentagent.com` | ⏳ Verify |
...
- [x] Site URL: `https://inbox-sync-3.preview.emergentagent.com`
- [ ] **ADD** Redirect URL: `https://inbox-sync-3.preview.emergentagent.com/auth/callback`
- [ ] **ADD** Redirect URL: `https://inbox-sync-3.preview.emergentagent.com/**`
...
Auth Callback: https://inbox-sync-3.preview.emergentagent.com/auth/callback
```
