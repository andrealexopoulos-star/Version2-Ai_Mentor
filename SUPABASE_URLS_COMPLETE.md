...
|---------|-------|--------|
| **Site URL** | `https://biqc-integrity.preview.emergentagent.com` | ⏳ Verify |
...
- [x] Site URL: `https://biqc-integrity.preview.emergentagent.com`
- [ ] **ADD** Redirect URL: `https://biqc-integrity.preview.emergentagent.com/auth/callback`
- [ ] **ADD** Redirect URL: `https://biqc-integrity.preview.emergentagent.com/**`
...
Auth Callback: https://biqc-integrity.preview.emergentagent.com/auth/callback
```
