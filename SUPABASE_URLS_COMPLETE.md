...
|---------|-------|--------|
| **Site URL** | `https://biqc-advisor.preview.emergentagent.com` | ⏳ Verify |
...
- [x] Site URL: `https://biqc-advisor.preview.emergentagent.com`
- [ ] **ADD** Redirect URL: `https://biqc-advisor.preview.emergentagent.com/auth/callback`
- [ ] **ADD** Redirect URL: `https://biqc-advisor.preview.emergentagent.com/**`
...
Auth Callback: https://biqc-advisor.preview.emergentagent.com/auth/callback
```
