...
|---------|-------|--------|
| **Site URL** | `https://biqc-auth-edge.preview.emergentagent.com` | ⏳ Verify |
...
- [x] Site URL: `https://biqc-auth-edge.preview.emergentagent.com`
- [ ] **ADD** Redirect URL: `https://biqc-auth-edge.preview.emergentagent.com/auth/callback`
- [ ] **ADD** Redirect URL: `https://biqc-auth-edge.preview.emergentagent.com/**`
...
Auth Callback: https://biqc-auth-edge.preview.emergentagent.com/auth/callback
```
