...
FRONTEND_URL=https://beta-ready-deploy.preview.emergentagent.com
...
```
Site URL: https://beta-ready-deploy.preview.emergentagent.com
```
...
Callback: https://beta-ready-deploy.preview.emergentagent.com/auth/callback (React route)
...
UI Button: Integrations.js → "Connect Outlook"
  ↓
Login URL: https://beta-ready-deploy.preview.emergentagent.com/api/auth/outlook/login
  ↓
Microsoft OAuth
  ↓
Callback URL: https://beta-ready-deploy.preview.emergentagent.com/api/auth/outlook/callback
  ↓
Stores tokens → outlook_oauth_tokens table
  ↓
Redirects to: https://beta-ready-deploy.preview.emergentagent.com/integrations?outlook_connected=true
```
...
UI Button: Integrations.js → "Connect Gmail"
  ↓
Login URL: https://beta-ready-deploy.preview.emergentagent.com/api/auth/gmail/login
  ↓
Google OAuth
  ↓
Callback URL: https://beta-ready-deploy.preview.emergentagent.com/api/auth/gmail/callback
  ↓
Stores tokens → gmail_connections table
  ↓
Redirects to: https://beta-ready-deploy.preview.emergentagent.com/integrations?gmail_connected=true
```
...
```bash
# Health check
curl -s https://beta-ready-deploy.preview.emergentagent.com/api/health
...
curl -I https://beta-ready-deploy.preview.emergentagent.com/api/auth/outlook/login
...
curl -I https://beta-ready-deploy.preview.emergentagent.com/api/auth/gmail/login
...
curl -I "https://beta-ready-deploy.preview.emergentagent.com/api/auth/outlook/callback?code=test&state=test"
...
curl -I "https://beta-ready-deploy.preview.emergentagent.com/api/auth/gmail/callback?code=test&state=test"
...
- [ ] Redirect URI: `https://beta-ready-deploy.preview.emergentagent.com/api/auth/gmail/callback`
...
- [ ] Redirect URI: `https://beta-ready-deploy.preview.emergentagent.com/api/auth/outlook/callback`
...
- ✅ Gmail callback: `https://beta-ready-deploy.preview.emergentagent.com/api/auth/gmail/callback`
- ✅ Outlook callback: `https://beta-ready-deploy.preview.emergentagent.com/api/auth/outlook/callback`
- ✅ Supabase callback: `https://beta-ready-deploy.preview.emergentagent.com/auth/callback`
