...
```
BACKEND_URL=https://liquid-steel-preview.preview.emergentagent.com
FRONTEND_URL=https://liquid-steel-preview.preview.emergentagent.com
...
```
Site URL: https://liquid-steel-preview.preview.emergentagent.com
```
...
Callback: https://liquid-steel-preview.preview.emergentagent.com/auth/callback (React route)
...
UI Button: Integrations.js → "Connect Outlook"
  ↓
Login URL: https://liquid-steel-preview.preview.emergentagent.com/api/auth/outlook/login
  ↓
Microsoft OAuth
  ↓
Callback URL: https://liquid-steel-preview.preview.emergentagent.com/api/auth/outlook/callback
  ↓
Stores tokens → outlook_oauth_tokens table
  ↓
Redirects to: https://liquid-steel-preview.preview.emergentagent.com/integrations?outlook_connected=true
```
...
UI Button: Integrations.js → "Connect Gmail"
  ↓
Login URL: https://liquid-steel-preview.preview.emergentagent.com/api/auth/gmail/login
  ↓
Google OAuth
  ↓
Callback URL: https://liquid-steel-preview.preview.emergentagent.com/api/auth/gmail/callback
  ↓
Stores tokens → gmail_connections table
  ↓
Redirects to: https://liquid-steel-preview.preview.emergentagent.com/integrations?gmail_connected=true
```
...
```bash
# Health check
curl -s https://liquid-steel-preview.preview.emergentagent.com/api/health
...
curl -I https://liquid-steel-preview.preview.emergentagent.com/api/auth/outlook/login
...
curl -I https://liquid-steel-preview.preview.emergentagent.com/api/auth/gmail/login
...
curl -I "https://liquid-steel-preview.preview.emergentagent.com/api/auth/outlook/callback?code=test&state=test"
...
curl -I "https://liquid-steel-preview.preview.emergentagent.com/api/auth/gmail/callback?code=test&state=test"
...
- [ ] Redirect URI: `https://liquid-steel-preview.preview.emergentagent.com/api/auth/gmail/callback`
...
- [ ] Redirect URI: `https://liquid-steel-preview.preview.emergentagent.com/api/auth/outlook/callback`
...
- ✅ Gmail callback: `https://liquid-steel-preview.preview.emergentagent.com/api/auth/gmail/callback`
- ✅ Outlook callback: `https://liquid-steel-preview.preview.emergentagent.com/api/auth/outlook/callback`
- ✅ Supabase callback: `https://liquid-steel-preview.preview.emergentagent.com/auth/callback`
