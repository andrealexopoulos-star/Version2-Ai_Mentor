...
**Current Fork URL:** `https://biqc-ai-insights.preview.emergentagent.com`  
**Previous URL:** `https://biqc-ai-insights.preview.emergentagent.com`  
...
const redirectUrl = 'https://biqc-ai-insights.preview.emergentagent.com/integrations';
...
1. Open: `https://biqc-ai-insights.preview.emergentagent.com`
...
// ❌ BAD: Hardcoded
const redirectUrl = 'https://biqc-ai-insights.preview.emergentagent.com';
```
...
### ✅ Should Work:
1. Navigate to: `https://biqc-ai-insights.preview.emergentagent.com`
2. Click: "Sign in with Microsoft"
