...
**Current Fork URL:** `https://beta.thestrategysquad.com`  
**Previous URL:** `https://beta.thestrategysquad.com`  
...
const redirectUrl = 'https://beta.thestrategysquad.com/integrations';
...
1. Open: `https://beta.thestrategysquad.com`
...
// ❌ BAD: Hardcoded
const redirectUrl = 'https://beta.thestrategysquad.com';
```
...
### ✅ Should Work:
1. Navigate to: `https://beta.thestrategysquad.com`
2. Click: "Sign in with Microsoft"
