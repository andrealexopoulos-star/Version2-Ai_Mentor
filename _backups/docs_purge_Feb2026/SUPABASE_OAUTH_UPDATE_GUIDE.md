...
**Current Fork URL:** `https://agentic-advisor.preview.emergentagent.com`  
**Previous URL:** `https://agentic-advisor.preview.emergentagent.com`  
...
const redirectUrl = 'https://agentic-advisor.preview.emergentagent.com/integrations';
...
1. Open: `https://agentic-advisor.preview.emergentagent.com`
...
// ❌ BAD: Hardcoded
const redirectUrl = 'https://agentic-advisor.preview.emergentagent.com';
```
...
### ✅ Should Work:
1. Navigate to: `https://agentic-advisor.preview.emergentagent.com`
2. Click: "Sign in with Microsoft"
