...
# Backend API URL
BACKEND_URL = "https://admin-portal-launch.preview.emergentagent.com/api"
...
def main():
    ...
    print("   1. Log in at https://admin-portal-launch.preview.emergentagent.com/login-supabase")
