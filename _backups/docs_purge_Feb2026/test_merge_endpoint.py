...
# Backend API URL
BACKEND_URL = "https://liquid-steel-preview.preview.emergentagent.com/api"
...
def main():
    ...
    print("   1. Log in at https://liquid-steel-preview.preview.emergentagent.com/login-supabase")
