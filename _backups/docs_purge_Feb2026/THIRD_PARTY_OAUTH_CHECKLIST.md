...
- [ ] Redirect URI:
  - Platform: **Web**
  - URI: `https://admin-portal-launch.preview.emergentagent.com/api/auth/outlook/callback`
...
- [ ] Confirm redirect URI is: `https://admin-portal-launch.preview.emergentagent.com/api/auth/outlook/callback`
...
- [ ] Confirm Site URL: `https://admin-portal-launch.preview.emergentagent.com`
- [ ] Confirm Redirect URLs include: `https://admin-portal-launch.preview.emergentagent.com/auth/callback`
...
✅ **Backend URL:** `https://admin-portal-launch.preview.emergentagent.com`
✅ **Frontend URL:** `https://admin-portal-launch.preview.emergentagent.com`
