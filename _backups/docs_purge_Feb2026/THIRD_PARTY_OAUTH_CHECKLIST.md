...
- [ ] Redirect URI:
  - Platform: **Web**
  - URI: `https://biqc-performance-hub.preview.emergentagent.com/api/auth/outlook/callback`
...
- [ ] Confirm redirect URI is: `https://biqc-performance-hub.preview.emergentagent.com/api/auth/outlook/callback`
...
- [ ] Confirm Site URL: `https://biqc-performance-hub.preview.emergentagent.com`
- [ ] Confirm Redirect URLs include: `https://biqc-performance-hub.preview.emergentagent.com/auth/callback`
...
✅ **Backend URL:** `https://biqc-performance-hub.preview.emergentagent.com`
✅ **Frontend URL:** `https://biqc-performance-hub.preview.emergentagent.com`
