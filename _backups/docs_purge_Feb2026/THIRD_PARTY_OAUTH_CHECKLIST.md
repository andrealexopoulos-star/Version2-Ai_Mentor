...
- [ ] Redirect URI:
  - Platform: **Web**
  - URI: `https://biqc-production-fix.preview.emergentagent.com/api/auth/outlook/callback`
...
- [ ] Confirm redirect URI is: `https://biqc-production-fix.preview.emergentagent.com/api/auth/outlook/callback`
...
- [ ] Confirm Site URL: `https://biqc-production-fix.preview.emergentagent.com`
- [ ] Confirm Redirect URLs include: `https://biqc-production-fix.preview.emergentagent.com/auth/callback`
...
✅ **Backend URL:** `https://biqc-production-fix.preview.emergentagent.com`
✅ **Frontend URL:** `https://biqc-production-fix.preview.emergentagent.com`
