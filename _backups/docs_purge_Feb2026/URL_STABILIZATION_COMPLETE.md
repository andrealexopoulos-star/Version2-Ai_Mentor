...
```javascript
// OLD (BROKEN):
const apiUrl = "https://agentic-advisor.preview.emergentagent.com/api"
...
```python
# OLD (BROKEN):
redirect_uri = "https://agentic-advisor.preview.emergentagent.com/callback"
...
```bash
# User flow:
1. Visit https://agentic-advisor.preview.emergentagent.com
