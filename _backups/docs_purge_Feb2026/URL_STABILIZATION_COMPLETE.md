...
```javascript
// OLD (BROKEN):
const apiUrl = "https://intelligence-hub-12.preview.emergentagent.com/api"
...
```python
# OLD (BROKEN):
redirect_uri = "https://intelligence-hub-12.preview.emergentagent.com/callback"
...
```bash
# User flow:
1. Visit https://intelligence-hub-12.preview.emergentagent.com
