...
```javascript
// OLD (BROKEN):
const apiUrl = "https://ai-strategic-hub.preview.emergentagent.com/api"
...
```python
# OLD (BROKEN):
redirect_uri = "https://ai-strategic-hub.preview.emergentagent.com/callback"
...
```bash
# User flow:
1. Visit https://ai-strategic-hub.preview.emergentagent.com
