...
```javascript
// OLD (BROKEN):
const apiUrl = "https://market-cognitive.preview.emergentagent.com/api"
...
```python
# OLD (BROKEN):
redirect_uri = "https://market-cognitive.preview.emergentagent.com/callback"
...
```bash
# User flow:
1. Visit https://market-cognitive.preview.emergentagent.com
