...
```javascript
// OLD (BROKEN):
const apiUrl = "https://beta-ready-deploy.preview.emergentagent.com/api"
...
```python
# OLD (BROKEN):
redirect_uri = "https://beta-ready-deploy.preview.emergentagent.com/callback"
...
```bash
# User flow:
1. Visit https://beta-ready-deploy.preview.emergentagent.com
