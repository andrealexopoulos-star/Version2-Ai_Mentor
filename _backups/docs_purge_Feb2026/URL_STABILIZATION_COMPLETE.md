...
```javascript
// OLD (BROKEN):
const apiUrl = "https://titan-glass.preview.emergentagent.com/api"
...
```python
# OLD (BROKEN):
redirect_uri = "https://titan-glass.preview.emergentagent.com/callback"
...
```bash
# User flow:
1. Visit https://titan-glass.preview.emergentagent.com
