...
### Step 1: Log In
1. Open browser and navigate to: https://biqc-production-fix.preview.emergentagent.com/login-supabase
...
1. After successful login, navigate to: https://biqc-production-fix.preview.emergentagent.com/integrations
...
- Frontend: `REACT_APP_BACKEND_URL=https://biqc-production-fix.preview.emergentagent.com`
