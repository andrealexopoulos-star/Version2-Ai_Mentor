...
### Email Inbox Page
```
https://beta.thestrategysquad.com/email-inbox
```
...
### Microsoft Azure
- [ ] Redirect URI added: `https://beta.thestrategysquad.com/api/auth/outlook/callback`
- [ ] Clicked "Save"

### Google Cloud Console
- [ ] Redirect URI added: `https://beta.thestrategysquad.com/api/auth/gmail/callback`
- [ ] Clicked "SAVE"

### Supabase URL Configuration
- [ ] Site URL set: `https://beta.thestrategysquad.com`
...
### Merge.dev
- [ ] Redirect URI: `https://beta.thestrategysquad.com/integrations`
- [ ] Clicked "Save"
...
1. Go to: `https://beta.thestrategysquad.com/connect-email`
...
1. Go to: `https://beta.thestrategysquad.com/integrations`
...
- Double-check Azure redirect URI is EXACTLY: `https://beta.thestrategysquad.com/api/auth/outlook/callback`
...
- Double-check Google redirect URI is EXACTLY: `https://beta.thestrategysquad.com/api/auth/gmail/callback`
- Click SAVE in Google Cloud Console
- Wait 1-2 minutes

### If Edge Functions return "Unauthorized"
- Check that BACKEND_URL secret is set to: `https://beta.thestrategysquad.com`
...
**Production URL**: https://beta.thestrategysquad.com  
