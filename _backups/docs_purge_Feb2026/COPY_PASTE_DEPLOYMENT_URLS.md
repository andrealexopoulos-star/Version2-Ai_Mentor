...
```
https://biqc-unblock-prod.preview.emergentagent.com/dashboard
```
...
### Login Page
```
https://biqc-unblock-prod.preview.emergentagent.com/login
```
...
### Microsoft Azure
- [ ] Redirect URI added: `https://biqc-unblock-prod.preview.emergentagent.com/api/auth/outlook/callback`
- [ ] Clicked "Save"

### Google Cloud Console
- [ ] Redirect URI added: `https://biqc-unblock-prod.preview.emergentagent.com/api/auth/gmail/callback`
- [ ] Clicked "SAVE"

### Supabase URL Configuration
- [ ] Site URL set: `https://biqc-unblock-prod.preview.emergentagent.com`
...
### Merge.dev
- [ ] Redirect URI: `https://biqc-unblock-prod.preview.emergentagent.com/integrations`
- [ ] Clicked "Save"
...
1. Go to: `https://biqc-unblock-prod.preview.emergentagent.com/connect-email`
...
1. Go to: `https://biqc-unblock-prod.preview.emergentagent.com/integrations`
...
- Double-check Azure redirect URI is EXACTLY: `https://biqc-unblock-prod.preview.emergentagent.com/api/auth/outlook/callback`
...
- Double-check Google redirect URI is EXACTLY: `https://biqc-unblock-prod.preview.emergentagent.com/api/auth/gmail/callback`
- Click SAVE in Google Cloud Console
- Wait 1-2 minutes

### If Edge Functions return "Unauthorized"
- Check that BACKEND_URL secret is set to: `https://biqc-unblock-prod.preview.emergentagent.com`
...
**Production URL**: https://biqc-unblock-prod.preview.emergentagent.com  
