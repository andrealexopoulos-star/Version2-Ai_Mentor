...
|---------|-------|--------|
| **Site URL** | `https://beta-ready-deploy.preview.emergentagent.com` | ⏳ Verify |
...
- [x] Site URL: `https://beta-ready-deploy.preview.emergentagent.com`
- [ ] **ADD** Redirect URL: `https://beta-ready-deploy.preview.emergentagent.com/auth/callback`
- [ ] **ADD** Redirect URL: `https://beta-ready-deploy.preview.emergentagent.com/**`
...
Auth Callback: https://beta-ready-deploy.preview.emergentagent.com/auth/callback
```
