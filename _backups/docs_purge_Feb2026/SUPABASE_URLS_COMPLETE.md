...
|---------|-------|--------|
| **Site URL** | `https://biqc-performance-hub.preview.emergentagent.com` | ⏳ Verify |
...
- [x] Site URL: `https://biqc-performance-hub.preview.emergentagent.com`
- [ ] **ADD** Redirect URL: `https://biqc-performance-hub.preview.emergentagent.com/auth/callback`
- [ ] **ADD** Redirect URL: `https://biqc-performance-hub.preview.emergentagent.com/**`
...
Auth Callback: https://biqc-performance-hub.preview.emergentagent.com/auth/callback
```
