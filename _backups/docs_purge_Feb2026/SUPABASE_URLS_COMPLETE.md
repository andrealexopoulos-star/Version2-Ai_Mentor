...
|---------|-------|--------|
| **Site URL** | `https://beta.thestrategysquad.com` | ⏳ Verify |
...
- [x] Site URL: `https://beta.thestrategysquad.com`
- [ ] **ADD** Redirect URL: `https://beta.thestrategysquad.com/auth/callback`
- [ ] **ADD** Redirect URL: `https://beta.thestrategysquad.com/**`
...
Auth Callback: https://beta.thestrategysquad.com/auth/callback
```
