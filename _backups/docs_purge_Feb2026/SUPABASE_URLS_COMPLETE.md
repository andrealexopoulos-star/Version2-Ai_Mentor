...
|---------|-------|--------|
| **Site URL** | `https://titan-glass.preview.emergentagent.com` | ⏳ Verify |
...
- [x] Site URL: `https://titan-glass.preview.emergentagent.com`
- [ ] **ADD** Redirect URL: `https://titan-glass.preview.emergentagent.com/auth/callback`
- [ ] **ADD** Redirect URL: `https://titan-glass.preview.emergentagent.com/**`
...
Auth Callback: https://titan-glass.preview.emergentagent.com/auth/callback
```
