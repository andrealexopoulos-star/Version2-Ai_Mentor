...
|---------|-------|--------|
| **Site URL** | `https://admin-portal-launch.preview.emergentagent.com` | ⏳ Verify |
...
- [x] Site URL: `https://admin-portal-launch.preview.emergentagent.com`
- [ ] **ADD** Redirect URL: `https://admin-portal-launch.preview.emergentagent.com/auth/callback`
- [ ] **ADD** Redirect URL: `https://admin-portal-launch.preview.emergentagent.com/**`
...
Auth Callback: https://admin-portal-launch.preview.emergentagent.com/auth/callback
```
