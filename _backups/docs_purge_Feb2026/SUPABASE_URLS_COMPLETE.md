...
|---------|-------|--------|
| **Site URL** | `https://data-harmony-fix.preview.emergentagent.com` | ⏳ Verify |
...
- [x] Site URL: `https://data-harmony-fix.preview.emergentagent.com`
- [ ] **ADD** Redirect URL: `https://data-harmony-fix.preview.emergentagent.com/auth/callback`
- [ ] **ADD** Redirect URL: `https://data-harmony-fix.preview.emergentagent.com/**`
...
Auth Callback: https://data-harmony-fix.preview.emergentagent.com/auth/callback
```
