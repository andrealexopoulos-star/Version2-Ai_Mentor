...
|---------|-------|--------|
| **Site URL** | `https://agentic-advisor.preview.emergentagent.com` | ⏳ Verify |
...
- [x] Site URL: `https://agentic-advisor.preview.emergentagent.com`
- [ ] **ADD** Redirect URL: `https://agentic-advisor.preview.emergentagent.com/auth/callback`
- [ ] **ADD** Redirect URL: `https://agentic-advisor.preview.emergentagent.com/**`
...
Auth Callback: https://agentic-advisor.preview.emergentagent.com/auth/callback
```
