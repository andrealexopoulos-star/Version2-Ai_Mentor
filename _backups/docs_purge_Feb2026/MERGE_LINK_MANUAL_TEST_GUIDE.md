...
2. OR directly navigate to: https://biqc-production-fix.preview.emergentagent.com/integrations
...
**Solution:**
1. Log in at https://biqc-production-fix.preview.emergentagent.com/login-supabase
