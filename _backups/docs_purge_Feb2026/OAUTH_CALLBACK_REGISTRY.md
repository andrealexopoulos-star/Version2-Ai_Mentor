...
- **Callback URL in Supabase Dashboard:** Must include `https://admin-portal-launch.preview.emergentagent.com/auth/callback`
...
- Supabase OAuth: `https://admin-portal-launch.preview.emergentagent.com/auth/callback` (React route)
- Outlook: `https://admin-portal-launch.preview.emergentagent.com/api/auth/outlook/callback`
- Gmail: `https://admin-portal-launch.preview.emergentagent.com/api/auth/gmail/callback`
...
- [ ] Redirect URI: `https://admin-portal-launch.preview.emergentagent.com/auth/callback`
