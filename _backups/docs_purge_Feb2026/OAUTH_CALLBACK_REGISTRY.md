...
- **Callback URL in Supabase Dashboard:** Must include `https://agentic-advisor.preview.emergentagent.com/auth/callback`
...
- Supabase OAuth: `https://agentic-advisor.preview.emergentagent.com/auth/callback` (React route)
- Outlook: `https://agentic-advisor.preview.emergentagent.com/api/auth/outlook/callback`
- Gmail: `https://agentic-advisor.preview.emergentagent.com/api/auth/gmail/callback`
...
- [ ] Redirect URI: `https://agentic-advisor.preview.emergentagent.com/auth/callback`
