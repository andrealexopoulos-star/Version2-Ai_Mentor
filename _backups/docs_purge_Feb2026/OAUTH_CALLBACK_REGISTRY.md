...
- **Callback URL in Supabase Dashboard:** Must include `https://biqc-production-fix.preview.emergentagent.com/auth/callback`
...
- Supabase OAuth: `https://biqc-production-fix.preview.emergentagent.com/auth/callback` (React route)
- Outlook: `https://biqc-production-fix.preview.emergentagent.com/api/auth/outlook/callback`
- Gmail: `https://biqc-production-fix.preview.emergentagent.com/api/auth/gmail/callback`
...
- [ ] Redirect URI: `https://biqc-production-fix.preview.emergentagent.com/auth/callback`
