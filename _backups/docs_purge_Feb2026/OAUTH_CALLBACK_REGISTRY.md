...
- **Callback URL in Supabase Dashboard:** Must include `https://biqc-performance-hub.preview.emergentagent.com/auth/callback`
...
- Supabase OAuth: `https://biqc-performance-hub.preview.emergentagent.com/auth/callback` (React route)
- Outlook: `https://biqc-performance-hub.preview.emergentagent.com/api/auth/outlook/callback`
- Gmail: `https://biqc-performance-hub.preview.emergentagent.com/api/auth/gmail/callback`
...
- [ ] Redirect URI: `https://biqc-performance-hub.preview.emergentagent.com/auth/callback`
