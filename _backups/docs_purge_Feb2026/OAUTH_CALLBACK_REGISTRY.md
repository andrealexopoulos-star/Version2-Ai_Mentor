...
- **Callback URL in Supabase Dashboard:** Must include `https://biqc-unblock-prod.preview.emergentagent.com/auth/callback`
...
- Supabase OAuth: `https://biqc-unblock-prod.preview.emergentagent.com/auth/callback` (React route)
- Outlook: `https://biqc-unblock-prod.preview.emergentagent.com/api/auth/outlook/callback`
- Gmail: `https://biqc-unblock-prod.preview.emergentagent.com/api/auth/gmail/callback`
...
- [ ] Redirect URI: `https://biqc-unblock-prod.preview.emergentagent.com/auth/callback`
