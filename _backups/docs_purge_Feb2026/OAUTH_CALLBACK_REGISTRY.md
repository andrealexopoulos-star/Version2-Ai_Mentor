...
- **Callback URL in Supabase Dashboard:** Must include `https://data-harmony-fix.preview.emergentagent.com/auth/callback`
...
- Supabase OAuth: `https://data-harmony-fix.preview.emergentagent.com/auth/callback` (React route)
...
- [ ] Redirect URI: `https://data-harmony-fix.preview.emergentagent.com/auth/callback`
