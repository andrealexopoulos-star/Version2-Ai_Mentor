...
- **Callback URL in Supabase Dashboard:** Must include `https://liquid-steel-preview.preview.emergentagent.com/auth/callback`
...
- Supabase OAuth: `https://liquid-steel-preview.preview.emergentagent.com/auth/callback` (React route)
- Outlook: `https://liquid-steel-preview.preview.emergentagent.com/api/auth/outlook/callback`
- Gmail: `https://liquid-steel-preview.preview.emergentagent.com/api/auth/gmail/callback`
...
- [ ] Redirect URI: `https://liquid-steel-preview.preview.emergentagent.com/auth/callback`
