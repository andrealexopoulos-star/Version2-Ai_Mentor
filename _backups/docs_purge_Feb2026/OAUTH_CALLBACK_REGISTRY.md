...
- **Callback URL in Supabase Dashboard:** Must include `https://beta.thestrategysquad.com/auth/callback`
...
- Supabase OAuth: `https://beta.thestrategysquad.com/auth/callback` (React route)
...
- [ ] Redirect URI: `https://beta.thestrategysquad.com/auth/callback`
