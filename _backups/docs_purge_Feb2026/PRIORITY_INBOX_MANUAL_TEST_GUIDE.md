...
- **Application URL**: https://biqc-production-fix.preview.emergentagent.com
...
4. After successful login, navigate to: https://biqc-production-fix.preview.emergentagent.com/email-inbox
