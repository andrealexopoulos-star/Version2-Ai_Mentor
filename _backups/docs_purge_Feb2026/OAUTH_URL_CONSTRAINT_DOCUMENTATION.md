...
**Working URL:** `https://ai-strategic-hub.preview.emergentagent.com`
...
**Active URL:** `https://ai-strategic-hub.preview.emergentagent.com`

**Environment Variables:**
```
REACT_APP_BACKEND_URL=https://ai-strategic-hub.preview.emergentagent.com
...
**USE ONLY:** `https://ai-strategic-hub.preview.emergentagent.com`

**Workflow:**
1. Navigate to: `https://ai-strategic-hub.preview.emergentagent.com`
...
**CAN USE:** `https://ai-strategic-hub.preview.emergentagent.com` (this fork)
...
```
Frontend: https://ai-strategic-hub.preview.emergentagent.com
Backend: https://ai-strategic-hub.preview.emergentagent.com/api
...
- **YOU MUST USE:** `https://ai-strategic-hub.preview.emergentagent.com`
