...
**Working URL:** `https://beta.thestrategysquad.com`
...
**Active URL:** `https://beta.thestrategysquad.com`
...
**USE ONLY:** `https://beta.thestrategysquad.com`
...
**CAN USE:** `https://beta.thestrategysquad.com` (this fork)
...
- **YOU MUST USE:** `https://beta.thestrategysquad.com`
