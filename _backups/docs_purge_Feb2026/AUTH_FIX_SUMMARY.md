...
**Status:** FIXED  
**URL:** https://beta.thestrategysquad.com
...
- Updated Site URL to: `https://beta.thestrategysquad.com`
- Added Redirect URL wildcard: `https://beta.thestrategysquad.com/**`
...
1. Visit: https://beta.thestrategysquad.com/login-supabase
...
4. Expected flow:
   - Redirect to: `https://beta.thestrategysquad.com/auth/callback#access_token=...`
   - Process tokens
   - Create session
...
2. Visit: https://beta.thestrategysquad.com
3. Try BOTH:
   - Email login
   - Google OAuth login
