...
**Status:** FIXED  
**URL:** https://agentic-advisor.preview.emergentagent.com
...
- Updated Site URL to: `https://agentic-advisor.preview.emergentagent.com`
- Added Redirect URL wildcard: `https://agentic-advisor.preview.emergentagent.com/**`
...
1. Visit: https://agentic-advisor.preview.emergentagent.com/login-supabase
...
4. Expected flow:
   - Redirect to: `https://agentic-advisor.preview.emergentagent.com/auth/callback#access_token=...`
   - Process tokens
   - Create session
...
2. Visit: https://agentic-advisor.preview.emergentagent.com
3. Try BOTH:
   - Email login
   - Google OAuth login
