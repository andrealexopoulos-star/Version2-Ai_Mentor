...
**Status:** FIXED  
**URL:** https://beta-ready-deploy.preview.emergentagent.com
...
- Updated Site URL to: `https://beta-ready-deploy.preview.emergentagent.com`
- Added Redirect URL wildcard: `https://beta-ready-deploy.preview.emergentagent.com/**`
...
1. Visit: https://beta-ready-deploy.preview.emergentagent.com/login-supabase
...
4. Expected flow:
   - Redirect to: `https://beta-ready-deploy.preview.emergentagent.com/auth/callback#access_token=...`
   - Process tokens
   - Create session
...
2. Visit: https://beta-ready-deploy.preview.emergentagent.com
3. Try BOTH:
   - Email login
   - Google OAuth login
