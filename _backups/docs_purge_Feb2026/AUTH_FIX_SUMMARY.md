...
**Status:** FIXED  
**URL:** https://admin-portal-launch.preview.emergentagent.com
...
- Updated Site URL to: `https://admin-portal-launch.preview.emergentagent.com`
- Added Redirect URL wildcard: `https://admin-portal-launch.preview.emergentagent.com/**`
...
1. Visit: https://admin-portal-launch.preview.emergentagent.com/login-supabase
...
4. Expected flow:
   - Redirect to: `https://admin-portal-launch.preview.emergentagent.com/auth/callback#access_token=...`
   - Process tokens
   - Create session
...
2. Visit: https://admin-portal-launch.preview.emergentagent.com
3. Try BOTH:
   - Email login
   - Google OAuth login
