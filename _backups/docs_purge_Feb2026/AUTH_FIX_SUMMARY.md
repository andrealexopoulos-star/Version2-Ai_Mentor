...
**Status:** FIXED  
**URL:** https://liquid-steel-preview.preview.emergentagent.com
...
- Updated Site URL to: `https://liquid-steel-preview.preview.emergentagent.com`
- Added Redirect URL wildcard: `https://liquid-steel-preview.preview.emergentagent.com/**`
...
1. Visit: https://liquid-steel-preview.preview.emergentagent.com/login-supabase
...
4. Expected flow:
   - Redirect to: `https://liquid-steel-preview.preview.emergentagent.com/auth/callback#access_token=...`
   - Process tokens
   - Create session
...
2. Visit: https://liquid-steel-preview.preview.emergentagent.com
3. Try BOTH:
   - Email login
   - Google OAuth login
