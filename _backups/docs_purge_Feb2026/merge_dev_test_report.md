...
**Backend URL:** https://ai-strategic-hub.preview.emergentagent.com/api
...
1. **Log in to the application:**
   - Navigate to: https://ai-strategic-hub.preview.emergentagent.com/login-supabase
...
3. Copy the token and run:
   ```bash
   curl -X POST https://ai-strategic-hub.preview.emergentagent.com/api/integrations/merge/link-token \
...
1. **User should log in** at https://ai-strategic-hub.preview.emergentagent.com/login-supabase
...
**Test Environment:** Production (https://ai-strategic-hub.preview.emergentagent.com)  
