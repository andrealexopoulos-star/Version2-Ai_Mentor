...
**Backend URL:** https://agentic-advisor.preview.emergentagent.com/api
...
1. **Log in to the application:**
   - Navigate to: https://agentic-advisor.preview.emergentagent.com/login-supabase
...
3. Copy the token and run:
   ```bash
   curl -X POST https://agentic-advisor.preview.emergentagent.com/api/integrations/merge/link-token \
...
1. **User should log in** at https://agentic-advisor.preview.emergentagent.com/login-supabase
...
**Test Environment:** Production (https://agentic-advisor.preview.emergentagent.com)  
