...
**Backend URL:** https://liquid-steel-preview.preview.emergentagent.com/api
...
1. **Log in to the application:**
   - Navigate to: https://liquid-steel-preview.preview.emergentagent.com/login-supabase
...
3. **Run this command:**
   ```javascript
   fetch('https://liquid-steel-preview.preview.emergentagent.com/api/integrations/merge/link-token', {
     method: 'POST',
     headers: {
...
3. Copy the token and run:
   ```bash
   curl -X POST https://liquid-steel-preview.preview.emergentagent.com/api/integrations/merge/link-token \
...
1. **User should log in** at https://liquid-steel-preview.preview.emergentagent.com/login-supabase
...
**Test Environment:** Production (https://liquid-steel-preview.preview.emergentagent.com)  
