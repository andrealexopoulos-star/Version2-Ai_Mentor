...
**Status:** FIXED  
**URL:** https://calibration-hub-9.preview.emergentagent.com
...
- Updated Site URL to: `https://calibration-hub-9.preview.emergentagent.com`
- Added Redirect URL wildcard: `https://calibration-hub-9.preview.emergentagent.com/**`
...
1. Visit: https://calibration-hub-9.preview.emergentagent.com/login-supabase
...
4. Expected flow:
   - Redirect to: `https://calibration-hub-9.preview.emergentagent.com/auth/callback#access_token=...`
   - Process tokens
   - Create session
...
2. Visit: https://calibration-hub-9.preview.emergentagent.com
3. Try BOTH:
   - Email login
   - Google OAuth login
