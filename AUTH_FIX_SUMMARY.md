...
**Status:** FIXED  
**URL:** https://boardroom-console.preview.emergentagent.com
...
- Updated Site URL to: `https://boardroom-console.preview.emergentagent.com`
- Added Redirect URL wildcard: `https://boardroom-console.preview.emergentagent.com/**`
...
1. Visit: https://boardroom-console.preview.emergentagent.com/login-supabase
...
4. Expected flow:
   - Redirect to: `https://boardroom-console.preview.emergentagent.com/auth/callback#access_token=...`
   - Process tokens
   - Create session
...
2. Visit: https://boardroom-console.preview.emergentagent.com
3. Try BOTH:
   - Email login
   - Google OAuth login
