...
**Status:** FIXED  
**URL:** https://intel-pipeline.preview.emergentagent.com
...
- Updated Site URL to: `https://intel-pipeline.preview.emergentagent.com`
- Added Redirect URL wildcard: `https://intel-pipeline.preview.emergentagent.com/**`
...
1. Visit: https://intel-pipeline.preview.emergentagent.com/login-supabase
...
4. Expected flow:
   - Redirect to: `https://intel-pipeline.preview.emergentagent.com/auth/callback#access_token=...`
   - Process tokens
   - Create session
...
2. Visit: https://intel-pipeline.preview.emergentagent.com
3. Try BOTH:
   - Email login
   - Google OAuth login
