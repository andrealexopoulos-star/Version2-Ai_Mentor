...
**Status:** FIXED  
**URL:** https://executive-reveal.preview.emergentagent.com
...
- Updated Site URL to: `https://executive-reveal.preview.emergentagent.com`
- Added Redirect URL wildcard: `https://executive-reveal.preview.emergentagent.com/**`
...
1. Visit: https://executive-reveal.preview.emergentagent.com/login-supabase
...
4. Expected flow:
   - Redirect to: `https://executive-reveal.preview.emergentagent.com/auth/callback#access_token=...`
   - Process tokens
   - Create session
...
2. Visit: https://executive-reveal.preview.emergentagent.com
3. Try BOTH:
   - Email login
   - Google OAuth login
