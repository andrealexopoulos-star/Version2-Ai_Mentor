...
**Status:** FIXED  
**URL:** https://watchtower-ai.preview.emergentagent.com
...
- Updated Site URL to: `https://watchtower-ai.preview.emergentagent.com`
- Added Redirect URL wildcard: `https://watchtower-ai.preview.emergentagent.com/**`
...
1. Visit: https://watchtower-ai.preview.emergentagent.com/login-supabase
...
4. Expected flow:
   - Redirect to: `https://watchtower-ai.preview.emergentagent.com/auth/callback#access_token=...`
   - Process tokens
   - Create session
...
2. Visit: https://watchtower-ai.preview.emergentagent.com
3. Try BOTH:
   - Email login
   - Google OAuth login
