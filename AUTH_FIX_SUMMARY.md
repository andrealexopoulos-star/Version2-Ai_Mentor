...
**Status:** FIXED  
**URL:** https://biqc-fixer.preview.emergentagent.com
...
- Updated Site URL to: `https://biqc-fixer.preview.emergentagent.com`
- Added Redirect URL wildcard: `https://biqc-fixer.preview.emergentagent.com/**`
...
1. Visit: https://biqc-fixer.preview.emergentagent.com/login-supabase
...
4. Expected flow:
   - Redirect to: `https://biqc-fixer.preview.emergentagent.com/auth/callback#access_token=...`
   - Process tokens
   - Create session
...
2. Visit: https://biqc-fixer.preview.emergentagent.com
3. Try BOTH:
   - Email login
   - Google OAuth login
