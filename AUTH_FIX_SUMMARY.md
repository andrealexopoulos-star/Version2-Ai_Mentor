...
**Status:** FIXED  
**URL:** https://auth-loop-fix-4.preview.emergentagent.com
...
- Updated Site URL to: `https://auth-loop-fix-4.preview.emergentagent.com`
- Added Redirect URL wildcard: `https://auth-loop-fix-4.preview.emergentagent.com/**`
...
1. Visit: https://auth-loop-fix-4.preview.emergentagent.com/login-supabase
...
4. Expected flow:
   - Redirect to: `https://auth-loop-fix-4.preview.emergentagent.com/auth/callback#access_token=...`
   - Process tokens
   - Create session
...
2. Visit: https://auth-loop-fix-4.preview.emergentagent.com
3. Try BOTH:
   - Email login
   - Google OAuth login
