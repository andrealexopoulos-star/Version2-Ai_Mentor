...
**Status:** FIXED  
**URL:** https://html-bug-fixed.preview.emergentagent.com
...
- Updated Site URL to: `https://html-bug-fixed.preview.emergentagent.com`
- Added Redirect URL wildcard: `https://html-bug-fixed.preview.emergentagent.com/**`
...
1. Visit: https://html-bug-fixed.preview.emergentagent.com/login-supabase
...
4. Expected flow:
   - Redirect to: `https://html-bug-fixed.preview.emergentagent.com/auth/callback#access_token=...`
   - Process tokens
   - Create session
...
2. Visit: https://html-bug-fixed.preview.emergentagent.com
3. Try BOTH:
   - Email login
   - Google OAuth login
