...
**Status:** FIXED  
**URL:** https://stability-verify.preview.emergentagent.com
...
- Updated Site URL to: `https://stability-verify.preview.emergentagent.com`
- Added Redirect URL wildcard: `https://stability-verify.preview.emergentagent.com/**`
...
1. Visit: https://stability-verify.preview.emergentagent.com/login-supabase
...
4. Expected flow:
   - Redirect to: `https://stability-verify.preview.emergentagent.com/auth/callback#access_token=...`
   - Process tokens
   - Create session
...
2. Visit: https://stability-verify.preview.emergentagent.com
3. Try BOTH:
   - Email login
   - Google OAuth login
