...
1. **Go to:** `https://mobile-auth-app-5.preview.emergentagent.com`
...
5. **Open NEW tab and go to:**
   ```
   https://mobile-auth-app-5.preview.emergentagent.com/login-supabase
   ```
...
1. **After logging in, go to:**
   ```
   https://mobile-auth-app-5.preview.emergentagent.com/integrations
   ```
