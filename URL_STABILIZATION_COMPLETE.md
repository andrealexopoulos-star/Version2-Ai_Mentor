...
```javascript
// OLD (BROKEN):
const apiUrl = "https://boardroom-console.preview.emergentagent.com/api"
...
```python
# OLD (BROKEN):
redirect_uri = "https://boardroom-console.preview.emergentagent.com/callback"
...
```bash
# User flow:
1. Visit https://boardroom-console.preview.emergentagent.com
