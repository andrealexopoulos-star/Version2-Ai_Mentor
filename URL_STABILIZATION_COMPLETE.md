...
```javascript
// OLD (BROKEN):
const apiUrl = "https://full-stack-upgrade-5.preview.emergentagent.com/api"
...
```python
# OLD (BROKEN):
redirect_uri = "https://full-stack-upgrade-5.preview.emergentagent.com/callback"
...
```bash
# User flow:
1. Visit https://full-stack-upgrade-5.preview.emergentagent.com
