...
```javascript
// OLD (BROKEN):
const apiUrl = "https://inbox-sync-3.preview.emergentagent.com/api"
...
```python
# OLD (BROKEN):
redirect_uri = "https://inbox-sync-3.preview.emergentagent.com/callback"
...
```bash
# User flow:
1. Visit https://inbox-sync-3.preview.emergentagent.com
