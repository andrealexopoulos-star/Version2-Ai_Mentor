...
```javascript
// OLD (BROKEN):
const apiUrl = "https://warroom-strategic-ai.preview.emergentagent.com/api"
...
```python
# OLD (BROKEN):
redirect_uri = "https://warroom-strategic-ai.preview.emergentagent.com/callback"
...
```bash
# User flow:
1. Visit https://warroom-strategic-ai.preview.emergentagent.com
