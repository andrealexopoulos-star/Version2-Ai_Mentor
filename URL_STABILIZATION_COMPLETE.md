...
```javascript
// OLD (BROKEN):
const apiUrl = "https://watchtower-ai.preview.emergentagent.com/api"
...
```python
# OLD (BROKEN):
redirect_uri = "https://watchtower-ai.preview.emergentagent.com/callback"
...
```bash
# User flow:
1. Visit https://watchtower-ai.preview.emergentagent.com
