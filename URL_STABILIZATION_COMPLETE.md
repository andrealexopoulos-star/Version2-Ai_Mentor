...
```javascript
// OLD (BROKEN):
const apiUrl = "https://intel-pipeline.preview.emergentagent.com/api"
...
```python
# OLD (BROKEN):
redirect_uri = "https://intel-pipeline.preview.emergentagent.com/callback"
...
```bash
# User flow:
1. Visit https://intel-pipeline.preview.emergentagent.com
