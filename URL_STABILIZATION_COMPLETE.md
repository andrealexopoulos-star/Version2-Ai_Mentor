...
```javascript
// OLD (BROKEN):
const apiUrl = "https://auth-loop-fix-4.preview.emergentagent.com/api"
...
```python
# OLD (BROKEN):
redirect_uri = "https://auth-loop-fix-4.preview.emergentagent.com/callback"
...
```bash
# User flow:
1. Visit https://auth-loop-fix-4.preview.emergentagent.com
