...
```javascript
// OLD (BROKEN):
const apiUrl = "https://calibration-hub-9.preview.emergentagent.com/api"
...
```python
# OLD (BROKEN):
redirect_uri = "https://calibration-hub-9.preview.emergentagent.com/callback"
...
```bash
# User flow:
1. Visit https://calibration-hub-9.preview.emergentagent.com
