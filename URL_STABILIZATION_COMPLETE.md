...
```javascript
// OLD (BROKEN):
const apiUrl = "https://html-bug-fixed.preview.emergentagent.com/api"
...
```python
# OLD (BROKEN):
redirect_uri = "https://html-bug-fixed.preview.emergentagent.com/callback"
...
```bash
# User flow:
1. Visit https://html-bug-fixed.preview.emergentagent.com
