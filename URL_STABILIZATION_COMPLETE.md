...
```javascript
// OLD (BROKEN):
const apiUrl = "https://biqc-advisor-1.preview.emergentagent.com/api"
...
```python
# OLD (BROKEN):
redirect_uri = "https://biqc-advisor-1.preview.emergentagent.com/callback"
...
```bash
# User flow:
1. Visit https://biqc-advisor-1.preview.emergentagent.com
