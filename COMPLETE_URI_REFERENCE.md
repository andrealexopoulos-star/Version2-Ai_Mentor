...
FRONTEND_URL=https://biqc-advisor.preview.emergentagent.com
...
Callback: https://biqc-advisor.preview.emergentagent.com/auth/callback (React route)
...
UI Button: Integrations.js → "Connect Outlook"
  ↓
Login URL: https://biqc-advisor.preview.emergentagent.com/api/auth/outlook/login
  ↓
Microsoft OAuth
  ↓
Callback URL: https://biqc-advisor.preview.emergentagent.com/api/auth/outlook/callback
  ↓
Stores tokens → outlook_oauth_tokens table
  ↓
Redirects to: https://biqc-advisor.preview.emergentagent.com/integrations?outlook_connected=true
```
...
UI Button: Integrations.js → "Connect Gmail"
  ↓
Login URL: https://biqc-advisor.preview.emergentagent.com/api/auth/gmail/login
  ↓
Google OAuth
  ↓
Callback URL: https://biqc-advisor.preview.emergentagent.com/api/auth/gmail/callback
  ↓
Stores tokens → gmail_connections table
  ↓
Redirects to: https://biqc-advisor.preview.emergentagent.com/integrations?gmail_connected=true
```
...
```bash
# Health check
curl -s https://biqc-advisor.preview.emergentagent.com/api/health
...
curl -I https://biqc-advisor.preview.emergentagent.com/api/auth/outlook/login
...
curl -I https://biqc-advisor.preview.emergentagent.com/api/auth/gmail/login
...
curl -I "https://biqc-advisor.preview.emergentagent.com/api/auth/outlook/callback?code=test&state=test"
...
curl -I "https://biqc-advisor.preview.emergentagent.com/api/auth/gmail/callback?code=test&state=test"
...
- [ ] Redirect URI: `https://biqc-advisor.preview.emergentagent.com/api/auth/gmail/callback`
...
- ✅ Gmail callback: `https://biqc-advisor.preview.emergentagent.com/api/auth/gmail/callback`
- ✅ Outlook callback: `https://biqc-advisor.preview.emergentagent.com/api/auth/outlook/callback`
- ✅ Supabase callback: `https://biqc-advisor.preview.emergentagent.com/auth/callback`
