...
```
BACKEND_URL=https://intel-pipeline.preview.emergentagent.com
FRONTEND_URL=https://intel-pipeline.preview.emergentagent.com
...
```
https://intel-pipeline.preview.emergentagent.com/api/auth/gmail/callback
```
...
```
https://intel-pipeline.preview.emergentagent.com/api/auth/outlook/callback
```
...
```
Site URL: https://intel-pipeline.preview.emergentagent.com
```
...
Callback: https://intel-pipeline.preview.emergentagent.com/auth/callback (React route)
...
UI Button: Integrations.js → "Connect Outlook"
  ↓
Login URL: https://intel-pipeline.preview.emergentagent.com/api/auth/outlook/login
  ↓
Microsoft OAuth
  ↓
Callback URL: https://intel-pipeline.preview.emergentagent.com/api/auth/outlook/callback
  ↓
Stores tokens → outlook_oauth_tokens table
  ↓
Redirects to: https://intel-pipeline.preview.emergentagent.com/integrations?outlook_connected=true
```
...
UI Button: Integrations.js → "Connect Gmail"
  ↓
Login URL: https://intel-pipeline.preview.emergentagent.com/api/auth/gmail/login
  ↓
Google OAuth
  ↓
Callback URL: https://intel-pipeline.preview.emergentagent.com/api/auth/gmail/callback
  ↓
Stores tokens → gmail_connections table
  ↓
Redirects to: https://intel-pipeline.preview.emergentagent.com/integrations?gmail_connected=true
```
...
```bash
# Health check
curl -s https://intel-pipeline.preview.emergentagent.com/api/health
...
curl -I https://intel-pipeline.preview.emergentagent.com/api/auth/outlook/login
...
curl -I https://intel-pipeline.preview.emergentagent.com/api/auth/gmail/login
...
curl -I "https://intel-pipeline.preview.emergentagent.com/api/auth/outlook/callback?code=test&state=test"
...
curl -I "https://intel-pipeline.preview.emergentagent.com/api/auth/gmail/callback?code=test&state=test"
...
- [ ] Redirect URI: `https://intel-pipeline.preview.emergentagent.com/api/auth/gmail/callback`
...
- [ ] Redirect URI: `https://intel-pipeline.preview.emergentagent.com/api/auth/outlook/callback`
...
- ✅ Gmail callback: `https://intel-pipeline.preview.emergentagent.com/api/auth/gmail/callback`
- ✅ Outlook callback: `https://intel-pipeline.preview.emergentagent.com/api/auth/outlook/callback`
- ✅ Supabase callback: `https://intel-pipeline.preview.emergentagent.com/auth/callback`
