...
```
BACKEND_URL=https://calibration-hub-9.preview.emergentagent.com
FRONTEND_URL=https://calibration-hub-9.preview.emergentagent.com
...
Callback: https://calibration-hub-9.preview.emergentagent.com/auth/callback (React route)
...
UI Button: Integrations.js → "Connect Outlook"
  ↓
Login URL: https://calibration-hub-9.preview.emergentagent.com/api/auth/outlook/login
  ↓
Microsoft OAuth
  ↓
Callback URL: https://calibration-hub-9.preview.emergentagent.com/api/auth/outlook/callback
  ↓
Stores tokens → outlook_oauth_tokens table
  ↓
Redirects to: https://calibration-hub-9.preview.emergentagent.com/integrations?outlook_connected=true
```
...
UI Button: Integrations.js → "Connect Gmail"
  ↓
Login URL: https://calibration-hub-9.preview.emergentagent.com/api/auth/gmail/login
  ↓
Google OAuth
  ↓
Callback URL: https://calibration-hub-9.preview.emergentagent.com/api/auth/gmail/callback
  ↓
Stores tokens → gmail_connections table
  ↓
Redirects to: https://calibration-hub-9.preview.emergentagent.com/integrations?gmail_connected=true
```
...
```bash
# Health check
curl -s https://calibration-hub-9.preview.emergentagent.com/api/health
...
curl -I https://calibration-hub-9.preview.emergentagent.com/api/auth/outlook/login
...
curl -I https://calibration-hub-9.preview.emergentagent.com/api/auth/gmail/login
...
curl -I "https://calibration-hub-9.preview.emergentagent.com/api/auth/outlook/callback?code=test&state=test"
...
curl -I "https://calibration-hub-9.preview.emergentagent.com/api/auth/gmail/callback?code=test&state=test"
...
- [ ] Redirect URI: `https://calibration-hub-9.preview.emergentagent.com/api/auth/gmail/callback`
...
- [ ] Redirect URI: `https://calibration-hub-9.preview.emergentagent.com/api/auth/outlook/callback`
...
- ✅ Gmail callback: `https://calibration-hub-9.preview.emergentagent.com/api/auth/gmail/callback`
- ✅ Outlook callback: `https://calibration-hub-9.preview.emergentagent.com/api/auth/outlook/callback`
- ✅ Supabase callback: `https://calibration-hub-9.preview.emergentagent.com/auth/callback`
