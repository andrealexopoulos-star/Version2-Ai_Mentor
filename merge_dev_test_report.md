...
**Backend URL:** https://biqc-connect.preview.emergentagent.com/api
...
1. **Log in to the application:**
   - Navigate to: https://biqc-connect.preview.emergentagent.com/login-supabase
...
3. **Run this command:**
   ```javascript
   fetch('https://biqc-connect.preview.emergentagent.com/api/integrations/merge/link-token', {
     method: 'POST',
     headers: {
...
3. Copy the token and run:
   ```bash
   curl -X POST https://biqc-connect.preview.emergentagent.com/api/integrations/merge/link-token \
...
1. **User should log in** at https://biqc-connect.preview.emergentagent.com/login-supabase
...
**Test Environment:** Production (https://biqc-connect.preview.emergentagent.com)  
