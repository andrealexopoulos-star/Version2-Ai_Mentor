...
**Backend URL:** https://biqc-advisor-1.preview.emergentagent.com/api
...
1. **Log in to the application:**
   - Navigate to: https://biqc-advisor-1.preview.emergentagent.com/login-supabase
...
3. **Run this command:**
   ```javascript
   fetch('https://biqc-advisor-1.preview.emergentagent.com/api/integrations/merge/link-token', {
     method: 'POST',
     headers: {
...
1. **User should log in** at https://biqc-advisor-1.preview.emergentagent.com/login-supabase
...
**Test Environment:** Production (https://biqc-advisor-1.preview.emergentagent.com)  
