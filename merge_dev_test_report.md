...
**Backend URL:** https://calibration-hub-9.preview.emergentagent.com/api
...
1. **Log in to the application:**
   - Navigate to: https://calibration-hub-9.preview.emergentagent.com/login-supabase
...
3. **Run this command:**
   ```javascript
   fetch('https://calibration-hub-9.preview.emergentagent.com/api/integrations/merge/link-token', {
     method: 'POST',
     headers: {
...
3. Copy the token and run:
   ```bash
   curl -X POST https://calibration-hub-9.preview.emergentagent.com/api/integrations/merge/link-token \
...
1. **User should log in** at https://calibration-hub-9.preview.emergentagent.com/login-supabase
...
**Test Environment:** Production (https://calibration-hub-9.preview.emergentagent.com)  
