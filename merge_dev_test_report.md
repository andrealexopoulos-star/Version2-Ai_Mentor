...
**Backend URL:** https://full-stack-upgrade-5.preview.emergentagent.com/api
...
1. **Log in to the application:**
   - Navigate to: https://full-stack-upgrade-5.preview.emergentagent.com/login-supabase
...
3. **Run this command:**
   ```javascript
   fetch('https://full-stack-upgrade-5.preview.emergentagent.com/api/integrations/merge/link-token', {
     method: 'POST',
     headers: {
...
3. Copy the token and run:
   ```bash
   curl -X POST https://full-stack-upgrade-5.preview.emergentagent.com/api/integrations/merge/link-token \
...
1. **User should log in** at https://full-stack-upgrade-5.preview.emergentagent.com/login-supabase
...
**Test Environment:** Production (https://full-stack-upgrade-5.preview.emergentagent.com)  
