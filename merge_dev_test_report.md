...
**Backend URL:** https://watchtower-ai.preview.emergentagent.com/api
...
1. **Log in to the application:**
   - Navigate to: https://watchtower-ai.preview.emergentagent.com/login-supabase
...
3. **Run this command:**
   ```javascript
   fetch('https://watchtower-ai.preview.emergentagent.com/api/integrations/merge/link-token', {
     method: 'POST',
     headers: {
...
1. **User should log in** at https://watchtower-ai.preview.emergentagent.com/login-supabase
...
**Test Environment:** Production (https://watchtower-ai.preview.emergentagent.com)  
