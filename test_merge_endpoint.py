...
# Backend API URL
BACKEND_URL = "https://full-stack-upgrade-5.preview.emergentagent.com/api"
...
def main():
    ...
    print("   1. Log in at https://full-stack-upgrade-5.preview.emergentagent.com/login-supabase")
