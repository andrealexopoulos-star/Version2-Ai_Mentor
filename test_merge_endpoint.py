...
# Backend API URL
BACKEND_URL = "https://warroom-strategic-ai.preview.emergentagent.com/api"
...
def main():
    ...
    print("   1. Log in at https://warroom-strategic-ai.preview.emergentagent.com/login-supabase")
