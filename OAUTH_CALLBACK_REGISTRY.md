...
- **Callback URL in Supabase Dashboard:** Must include `https://beta-ready-deploy.preview.emergentagent.com/auth/callback`
...
- Supabase OAuth: `https://beta-ready-deploy.preview.emergentagent.com/auth/callback` (React route)
- Outlook: `https://beta-ready-deploy.preview.emergentagent.com/api/auth/outlook/callback`
- Gmail: `https://beta-ready-deploy.preview.emergentagent.com/api/auth/gmail/callback`
...
- [ ] Redirect URI: `https://beta-ready-deploy.preview.emergentagent.com/auth/callback`
