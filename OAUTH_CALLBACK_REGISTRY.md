...
- **Callback URL in Supabase Dashboard:** Must include `https://biqc-auth-edge.preview.emergentagent.com/auth/callback`
...
- Supabase OAuth: `https://biqc-auth-edge.preview.emergentagent.com/auth/callback` (React route)
- Outlook: `https://biqc-auth-edge.preview.emergentagent.com/api/auth/outlook/callback`
- Gmail: `https://biqc-auth-edge.preview.emergentagent.com/api/auth/gmail/callback`
...
- [ ] Redirect URI: `https://biqc-auth-edge.preview.emergentagent.com/auth/callback`
