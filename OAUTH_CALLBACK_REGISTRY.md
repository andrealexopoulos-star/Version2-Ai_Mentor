...
- **Callback URL in Supabase Dashboard:** Must include `https://intel-pipeline.preview.emergentagent.com/auth/callback`
...
- Supabase OAuth: `https://intel-pipeline.preview.emergentagent.com/auth/callback` (React route)
- Outlook: `https://intel-pipeline.preview.emergentagent.com/api/auth/outlook/callback`
- Gmail: `https://intel-pipeline.preview.emergentagent.com/api/auth/gmail/callback`
...
- [ ] Redirect URI: `https://intel-pipeline.preview.emergentagent.com/auth/callback`
