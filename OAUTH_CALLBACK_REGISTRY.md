...
- **Callback URL in Supabase Dashboard:** Must include `https://auth-loop-fix-4.preview.emergentagent.com/auth/callback`
...
- Supabase OAuth: `https://auth-loop-fix-4.preview.emergentagent.com/auth/callback` (React route)
- Outlook: `https://auth-loop-fix-4.preview.emergentagent.com/api/auth/outlook/callback`
- Gmail: `https://auth-loop-fix-4.preview.emergentagent.com/api/auth/gmail/callback`
...
- [ ] Redirect URI: `https://auth-loop-fix-4.preview.emergentagent.com/auth/callback`
