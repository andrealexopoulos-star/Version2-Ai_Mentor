...
- **Callback URL in Supabase Dashboard:** Must include `https://boardroom-console.preview.emergentagent.com/auth/callback`
...
- Supabase OAuth: `https://boardroom-console.preview.emergentagent.com/auth/callback` (React route)
- Outlook: `https://boardroom-console.preview.emergentagent.com/api/auth/outlook/callback`
- Gmail: `https://boardroom-console.preview.emergentagent.com/api/auth/gmail/callback`
...
- [ ] Redirect URI: `https://boardroom-console.preview.emergentagent.com/auth/callback`
