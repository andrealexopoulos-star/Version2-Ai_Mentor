...
- **Callback URL in Supabase Dashboard:** Must include `https://stability-verify.preview.emergentagent.com/auth/callback`
...
- Supabase OAuth: `https://stability-verify.preview.emergentagent.com/auth/callback` (React route)
- Outlook: `https://stability-verify.preview.emergentagent.com/api/auth/outlook/callback`
- Gmail: `https://stability-verify.preview.emergentagent.com/api/auth/gmail/callback`
...
- [ ] Redirect URI: `https://stability-verify.preview.emergentagent.com/auth/callback`
