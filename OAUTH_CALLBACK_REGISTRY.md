...
- **Callback URL in Supabase Dashboard:** Must include `https://html-bug-fixed.preview.emergentagent.com/auth/callback`
...
- Supabase OAuth: `https://html-bug-fixed.preview.emergentagent.com/auth/callback` (React route)
- Outlook: `https://html-bug-fixed.preview.emergentagent.com/api/auth/outlook/callback`
- Gmail: `https://html-bug-fixed.preview.emergentagent.com/api/auth/gmail/callback`
...
- [ ] Redirect URI: `https://html-bug-fixed.preview.emergentagent.com/auth/callback`
