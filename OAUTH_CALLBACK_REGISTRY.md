...
- **Callback URL in Supabase Dashboard:** Must include `https://inbox-sync-3.preview.emergentagent.com/auth/callback`
...
- Supabase OAuth: `https://inbox-sync-3.preview.emergentagent.com/auth/callback` (React route)
- Outlook: `https://inbox-sync-3.preview.emergentagent.com/api/auth/outlook/callback`
- Gmail: `https://inbox-sync-3.preview.emergentagent.com/api/auth/gmail/callback`
...
- [ ] Redirect URI: `https://inbox-sync-3.preview.emergentagent.com/auth/callback`
