...
```javascript
fetch('https://intel-pipeline.preview.emergentagent.com/api/integrations/crm/contacts', {
  headers: {
...
```javascript
fetch('https://intel-pipeline.preview.emergentagent.com/api/integrations/crm/contacts?page_size=10', {
  headers: {
    'Authorization': 'Bearer ' + JSON.parse(localStorage.getItem('sb-uxyqpdfftxpkzeppqtvk-auth-token')).access_token
  }
})
...
```javascript
fetch('https://intel-pipeline.preview.emergentagent.com/api/integrations/crm/companies', {
  headers: {
    'Authorization': 'Bearer ' + JSON.parse(localStorage.getItem('sb-uxyqpdfftxpkzeppqtvk-auth-token')).access_token
  }
})
...
#### Test 4: Fetch Deals
```javascript
fetch('https://intel-pipeline.preview.emergentagent.com/api/integrations/crm/deals', {
  headers: {
    'Authorization': 'Bearer ' + JSON.parse(localStorage.getItem('sb-uxyqpdfftxpkzeppqtvk-auth-token')).access_token
  }
})
...
#### Test 5: Fetch Owners
```javascript
fetch('https://intel-pipeline.preview.emergentagent.com/api/integrations/crm/owners', {
  headers: {
    'Authorization': 'Bearer ' + JSON.parse(localStorage.getItem('sb-uxyqpdfftxpkzeppqtvk-auth-token')).access_token
  }
})
