...
### Email Inbox Page
```
https://boardroom-console.preview.emergentagent.com/email-inbox
```
...
### Microsoft Azure
- [ ] Redirect URI added: `https://boardroom-console.preview.emergentagent.com/api/auth/outlook/callback`
- [ ] Clicked "Save"

### Google Cloud Console
- [ ] Redirect URI added: `https://boardroom-console.preview.emergentagent.com/api/auth/gmail/callback`
- [ ] Clicked "SAVE"

### Supabase URL Configuration
- [ ] Site URL set: `https://boardroom-console.preview.emergentagent.com`
...
### Merge.dev
- [ ] Redirect URI: `https://boardroom-console.preview.emergentagent.com/integrations`
- [ ] Clicked "Save"
...
1. Go to: `https://boardroom-console.preview.emergentagent.com/connect-email`
...
1. Go to: `https://boardroom-console.preview.emergentagent.com/integrations`
...
- Double-check Azure redirect URI is EXACTLY: `https://boardroom-console.preview.emergentagent.com/api/auth/outlook/callback`
...
- Double-check Google redirect URI is EXACTLY: `https://boardroom-console.preview.emergentagent.com/api/auth/gmail/callback`
- Click SAVE in Google Cloud Console
- Wait 1-2 minutes

### If Edge Functions return "Unauthorized"
- Check that BACKEND_URL secret is set to: `https://boardroom-console.preview.emergentagent.com`
...
**Production URL**: https://boardroom-console.preview.emergentagent.com  
