...
```
https://auth-loop-fix-4.preview.emergentagent.com/dashboard
```
...
### Login Page
```
https://auth-loop-fix-4.preview.emergentagent.com/login
```
...
- [ ] Site URL set: `https://auth-loop-fix-4.preview.emergentagent.com`
...
### Merge.dev
- [ ] Redirect URI: `https://auth-loop-fix-4.preview.emergentagent.com/integrations`
- [ ] Clicked "Save"
...
1. Go to: `https://auth-loop-fix-4.preview.emergentagent.com/connect-email`
...
1. Go to: `https://auth-loop-fix-4.preview.emergentagent.com/integrations`
...
- Double-check Azure redirect URI is EXACTLY: `https://auth-loop-fix-4.preview.emergentagent.com/api/auth/outlook/callback`
...
- Double-check Google redirect URI is EXACTLY: `https://auth-loop-fix-4.preview.emergentagent.com/api/auth/gmail/callback`
- Click SAVE in Google Cloud Console
- Wait 1-2 minutes

### If Edge Functions return "Unauthorized"
- Check that BACKEND_URL secret is set to: `https://auth-loop-fix-4.preview.emergentagent.com`
...
**Production URL**: https://auth-loop-fix-4.preview.emergentagent.com  
