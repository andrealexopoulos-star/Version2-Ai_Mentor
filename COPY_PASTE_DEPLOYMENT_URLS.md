...
```
https://calibration-hub-9.preview.emergentagent.com/dashboard
```
...
### Login Page
```
https://calibration-hub-9.preview.emergentagent.com/login
```
...
### Microsoft Azure
- [ ] Redirect URI added: `https://calibration-hub-9.preview.emergentagent.com/api/auth/outlook/callback`
- [ ] Clicked "Save"

### Google Cloud Console
- [ ] Redirect URI added: `https://calibration-hub-9.preview.emergentagent.com/api/auth/gmail/callback`
- [ ] Clicked "SAVE"

### Supabase URL Configuration
- [ ] Site URL set: `https://calibration-hub-9.preview.emergentagent.com`
...
### Merge.dev
- [ ] Redirect URI: `https://calibration-hub-9.preview.emergentagent.com/integrations`
- [ ] Clicked "Save"
...
1. Go to: `https://calibration-hub-9.preview.emergentagent.com/connect-email`
...
1. Go to: `https://calibration-hub-9.preview.emergentagent.com/integrations`
...
- Double-check Azure redirect URI is EXACTLY: `https://calibration-hub-9.preview.emergentagent.com/api/auth/outlook/callback`
...
- Double-check Google redirect URI is EXACTLY: `https://calibration-hub-9.preview.emergentagent.com/api/auth/gmail/callback`
- Click SAVE in Google Cloud Console
- Wait 1-2 minutes

### If Edge Functions return "Unauthorized"
- Check that BACKEND_URL secret is set to: `https://calibration-hub-9.preview.emergentagent.com`
...
**Production URL**: https://calibration-hub-9.preview.emergentagent.com  
