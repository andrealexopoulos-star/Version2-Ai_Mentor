...
```
https://warroom-strategic-ai.preview.emergentagent.com/dashboard
```
...
### Login Page
```
https://warroom-strategic-ai.preview.emergentagent.com/login
```
...
- [ ] Site URL set: `https://warroom-strategic-ai.preview.emergentagent.com`
...
### Merge.dev
- [ ] Redirect URI: `https://warroom-strategic-ai.preview.emergentagent.com/integrations`
- [ ] Clicked "Save"
...
1. Go to: `https://warroom-strategic-ai.preview.emergentagent.com/connect-email`
...
1. Go to: `https://warroom-strategic-ai.preview.emergentagent.com/integrations`
...
- Double-check Azure redirect URI is EXACTLY: `https://warroom-strategic-ai.preview.emergentagent.com/api/auth/outlook/callback`
...
- Double-check Google redirect URI is EXACTLY: `https://warroom-strategic-ai.preview.emergentagent.com/api/auth/gmail/callback`
- Click SAVE in Google Cloud Console
- Wait 1-2 minutes

### If Edge Functions return "Unauthorized"
- Check that BACKEND_URL secret is set to: `https://warroom-strategic-ai.preview.emergentagent.com`
...
**Production URL**: https://warroom-strategic-ai.preview.emergentagent.com  
