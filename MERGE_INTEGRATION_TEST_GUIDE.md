...
### Step 1: Log In
1. Open browser and navigate to: https://auth-loop-fix-4.preview.emergentagent.com/login-supabase
...
1. After successful login, navigate to: https://auth-loop-fix-4.preview.emergentagent.com/integrations
...
- Frontend: `REACT_APP_BACKEND_URL=https://auth-loop-fix-4.preview.emergentagent.com`
