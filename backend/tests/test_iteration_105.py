...
Preview URL: https://biqc-forensic.preview.emergentagent.com
"""
import pytest
import requests
import os
...
BASE_URL = os.environ.get("REACT_APP_BACKEND_URL", "https://biqc-forensic.preview.emergentagent.com").rstrip("/")
