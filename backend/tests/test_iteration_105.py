...
Preview URL: https://integrations-hub-10.preview.emergentagent.com
"""
import pytest
import requests
import os
...
BASE_URL = os.environ.get("REACT_APP_BACKEND_URL", "https://integrations-hub-10.preview.emergentagent.com").rstrip("/")
