...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://biqc-integrity.preview.emergentagent.com').rstrip('/')
...
class TestBackendIsRunning:
    ...
    def test_backend_cors(self):
        ...
        response = requests.options(
            ...
            headers={"Origin": "https://biqc-integrity.preview.emergentagent.com"}
        )
