...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://intelligence-hub-12.preview.emergentagent.com')
...
class TestHealthAndAPIAccess:
    ...
    def test_api_cors_headers(self):
        ...
        response = requests.options(
            ...
            headers={"Origin": "https://intelligence-hub-12.preview.emergentagent.com"}
        )
